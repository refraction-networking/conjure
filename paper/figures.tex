...
\begin{figure}[t]
    ...
    \caption{\textbf{Overview}---%
      When deployed at ISPs, \scheme monitors a passive network tap.
      ...
      address in the ISP's AS, and \scheme injects packets to communicates with the client as if it were a proxy server at that address.
    }
    \label{fig:overview}
\end{figure}
}
