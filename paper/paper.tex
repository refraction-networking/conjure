...
\begin{abstract}
%-------------------------------------------------------------------------------
Refraction Networking (formerly ``Decoy Routing'') has emerged as a useful tool in circumventing
...
However, existing deployed Refraction Networking schemes such as TapDance \nikita{TapDance is the only deployed scheme} suffer
...
We use PF\_RING built-in load balancer \textit{zbalance} to efficiently
