...
choice also allows censors to register suspected dark decoys and block them if
...
We note that IP addresses are selected from unused but still routed address
...
How do we get the list of masked sites? Alexa list? passive observation?
