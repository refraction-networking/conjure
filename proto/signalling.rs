...
#[derive(PartialEq,Clone,Default,Debug)]
// @@protoc_insertion_point(message:proto.UTLSTransportParams)
pub struct UTLSTransportParams {
    // message fields
    // @@protoc_insertion_point(field:proto.UTLSTransportParams.ch_id)
    pub ch_id: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:proto.UTLSTransportParams.ch_spec)
    pub ch_spec: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:proto.UTLSTransportParams.ciphersuite)
    pub ciphersuite: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:proto.UTLSTransportParams.sni)
    ...
    ///  supported.
    // @@protoc_insertion_point(field:proto.UTLSTransportParams.randomize_dst_port)
    pub randomize_dst_port: ::std::option::Option<bool>,
    // special fields
    // @@protoc_insertion_point(special_field:proto.UTLSTransportParams.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
