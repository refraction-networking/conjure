...
pub struct ClientConf {
    ...
    dark_decoy_blocks: ::protobuf::SingularPtrField<DarkDecoyBlocks>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl ClientConf {
    ...
    pub fn get_dark_decoy_blocks(&self) -> &DarkDecoyBlocks {
        self.dark_decoy_blocks.as_ref().unwrap_or_else(|| DarkDecoyBlocks::default_instance())
    }
...
pub struct DarkDecoyBlocks {
    // message fields
    blocks: ::protobuf::RepeatedField<::std::string::String>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl ::protobuf::Message for DarkDecoyBlocks {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<DarkDecoyBlocks>(
                    "DarkDecoyBlocks",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static DarkDecoyBlocks {
        static mut instance: ::protobuf::lazy::Lazy<DarkDecoyBlocks> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const DarkDecoyBlocks,
        };
        unsafe {
...
pub struct ClientToStation {
    ...
    c2s_transport: ::std::option::Option<u32>,
    padding: ::protobuf::SingularField<::std::vec::Vec<u8>>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
...
impl ClientToStation {
    ...
    // optional uint32 c2s_transport = 24;


    pub fn get_c2s_transport(&self) -> u32 {
        self.c2s_transport.unwrap_or(0)
    }
    pub fn clear_c2s_transport(&mut self) {
        self.c2s_transport = ::std::option::Option::None;
    }

    pub fn has_c2s_transport(&self) -> bool {
        self.c2s_transport.is_some()
    }

    // Param is passed by value, moved
    pub fn set_c2s_transport(&mut self, v: u32) {
        self.c2s_transport = ::std::option::Option::Some(v);
    }
...
impl ::protobuf::Message for ClientToStation {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                24 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.c2s_transport = ::std::option::Option::Some(tmp);
                },
                100 => {
                    ::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.padding)?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.c2s_transport {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                    "c2s_transport",
                    |m: &ClientToStation| { &m.c2s_transport },
                    |m: &mut ClientToStation| { &mut m.c2s_transport },
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "padding",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x05\x20\x01(\rR\x06tcpwin\"\xe0\x01\n\nClientConf\x122\n\ndecoy_lis\
    ...
    coyBlocks\"B\n\tDecoyList\x125\n\ntls_decoys\x18\x01\x20\x03(\x0b2\x16.t\
    apdance.TLSDecoySpecR\ttlsDecoys\")\n\x0fDarkDecoyBlocks\x12\x16\n\x06bl\
    ocks\x18\x01\x20\x03(\tR\x06blocks\"\xcb\x02\n\x0fStationToClient\x12)\n\
    \x10protocol_version\x18\x01\x20\x01(\rR\x0fprotocolVersion\x12C\n\x10st\
    ate_transition\x18\x02\x20\x01(\x0e2\x18.tapdance.S2C_TransitionR\x0fsta\
    teTransition\x125\n\x0bconfig_info\x18\x03\x20\x01(\x0b2\x14.tapdance.Cl\
    ientConfR\nconfigInfo\x127\n\nerr_reason\x18\x04\x20\x01(\x0e2\x18.tapda\
    nce.ErrorReasonS2CR\terrReason\x12\x1f\n\x0btmp_backoff\x18\x05\x20\x01(\
    \rR\ntmpBackoff\x12\x1d\n\nstation_id\x18\x06\x20\x01(\tR\tstationId\x12\
    ...
    \x04R\nuploadSync\x12#\n\rfailed_decoys\x18\n\x20\x03(\tR\x0cfailedDecoy\
    s\x12,\n\x05stats\x18\x0b\x20\x01(\x0b2\x16.tapdance.SessionStatsR\x05st\
    ...
    upport\x18\x17\x20\x01(\x08R\tv4Support\x12#\n\rc2s_transport\x18\x18\
    \x20\x01(\rR\x0cc2sTransport\x12\x18\n\x07padding\x18d\x20\x01(\x0cR\x07\
    ...
    \x04Q\0V\x012\xf6\x07\x20In\x20version\x201,\x20the\x20request\x20is\x20\
    ...
    \x04\x04\x02\0\x03\x12\x03]\x1d\x1e\n-\n\x02\x05\x01\x12\x04a\0k\x01\x1a\
    !\x20State\x20transitions\x20of\x20the\x20client\n\n\n\n\x03\x05\x01\x01\
    \x12\x03a\x05\x13\n\x0b\n\x04\x05\x01\x02\0\x12\x03b\x04\x16\n\x0c\n\x05\
    \x05\x01\x02\0\x01\x12\x03b\x04\x11\n\x0c\n\x05\x05\x01\x02\0\x02\x12\
    \x03b\x14\x15\n\"\n\x04\x05\x01\x02\x01\x12\x03c\x04\x19\"\x15\x20connec\
    t\x20me\x20to\x20squid\n\n\x0c\n\x05\x05\x01\x02\x01\x01\x12\x03c\x04\
    \x14\n\x0c\n\x05\x05\x01\x02\x01\x02\x12\x03c\x17\x18\n,\n\x04\x05\x01\
    \x02\x02\x12\x03d\x04!\"\x1f\x20connect\x20me\x20to\x20provided\x20cover\
    t\n\n\x0c\n\x05\x05\x01\x02\x02\x01\x12\x03d\x04\x1b\n\x0c\n\x05\x05\x01\
    \x02\x02\x02\x12\x03d\x1e\x20\n\x0b\n\x04\x05\x01\x02\x03\x12\x03e\x04\
    \x1d\n\x0c\n\x05\x05\x01\x02\x03\x01\x12\x03e\x04\x18\n\x0c\n\x05\x05\
    \x01\x02\x03\x02\x12\x03e\x1b\x1c\n\x0b\n\x04\x05\x01\x02\x04\x12\x03f\
    \x04\x1a\n\x0c\n\x05\x05\x01\x02\x04\x01\x12\x03f\x04\x15\n\x0c\n\x05\
    \x05\x01\x02\x04\x02\x12\x03f\x18\x19\n\x0b\n\x04\x05\x01\x02\x05\x12\
    ...
    \x02\x12\x03s\x18\x19\nR\n\x04\x05\x02\x02\x05\x12\x03u\x04\x14\x1aE\x20\
    ...
    y\0\x83\x01\x01\x1a*\x20Should\x20accompany\x20all\x20S2C_ERROR\x20messa\
    ...
    \x02\x12\x03}\x16\x17\n\x16\n\x04\x05\x03\x02\x04\x12\x03~\x04\x19\"\t\
    \x20I\x20broke\n\n\x0c\n\x05\x05\x03\x02\x04\x01\x12\x03~\x04\x14\n\x0c\
    \n\x05\x05\x03\x02\x04\x02\x12\x03~\x17\x18\nD\n\x04\x05\x03\x02\x05\x12\
    \x03\x7f\x04\x17\"7\x20Everything's\x20fine,\x20but\x20don't\x20use\x20t\
    his\x20decoy\x20right\x20now\n\n\x0c\n\x05\x05\x03\x02\x05\x01\x12\x03\
    \x7f\x04\x12\n\x0c\n\x05\x05\x03\x02\x05\x02\x12\x03\x7f\x15\x16\nD\n\
    \x04\x05\x03\x02\x06\x12\x04\x81\x01\x04\x18\"6\x20My\x20stream\x20to\
    \x20you\x20broke.\x20(This\x20is\x20impossible\x20to\x20send)\n\n\r\n\
    \x05\x05\x03\x02\x06\x01\x12\x04\x81\x01\x04\x11\n\r\n\x05\x05\x03\x02\
    \x06\x02\x12\x04\x81\x01\x14\x17\nA\n\x04\x05\x03\x02\x07\x12\x04\x82\
    \x01\x04\x19\"3\x20You\x20never\x20came\x20back.\x20(This\x20is\x20impos\
    sible\x20to\x20send)\n\n\r\n\x05\x05\x03\x02\x07\x01\x12\x04\x82\x01\x04\
    \x12\n\r\n\x05\x05\x03\x02\x07\x02\x12\x04\x82\x01\x15\x18\n\x0c\n\x02\
    \x04\x05\x12\x06\x85\x01\0\x9c\x01\x01\n\x0b\n\x03\x04\x05\x01\x12\x04\
    \x85\x01\x08\x17\nO\n\x04\x04\x05\x02\0\x12\x04\x87\x01\x04)\x1aA\x20Sho\
    uld\x20accompany\x20(at\x20least)\x20SESSION_INIT\x20and\x20CONFIRM_RECO\
    NNECT.\n\n\r\n\x05\x04\x05\x02\0\x04\x12\x04\x87\x01\x04\x0c\n\r\n\x05\
    \x04\x05\x02\0\x05\x12\x04\x87\x01\r\x13\n\r\n\x05\x04\x05\x02\0\x01\x12\
    \x04\x87\x01\x14$\n\r\n\x05\x04\x05\x02\0\x03\x12\x04\x87\x01'(\nv\n\x04\
    \x04\x05\x02\x01\x12\x04\x8b\x01\x041\x1ah\x20There\x20might\x20be\x20a\
    \x20state\x20transition.\x20May\x20be\x20absent;\x20absence\x20should\
    \x20be\n\x20treated\x20identically\x20to\x20NO_CHANGE.\n\n\r\n\x05\x04\
    \x05\x02\x01\x04\x12\x04\x8b\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x01\x06\
    \x12\x04\x8b\x01\r\x1b\n\r\n\x05\x04\x05\x02\x01\x01\x12\x04\x8b\x01\x1c\
    ,\n\r\n\x05\x04\x05\x02\x01\x03\x12\x04\x8b\x01/0\nc\n\x04\x04\x05\x02\
    \x02\x12\x04\x8f\x01\x04(\x1aU\x20The\x20station\x20can\x20send\x20clien\
    ...
    \x02\x02\x01\x12\x04\x8f\x01\x18#\n\r\n\x05\x04\x05\x02\x02\x03\x12\x04\
    \x8f\x01&'\nP\n\x04\x04\x05\x02\x03\x12\x04\x92\x01\x04+\x1aB\x20If\x20s\
    ...
    \x01\x12\x04\x92\x01\x1c&\n\r\n\x05\x04\x05\x02\x03\x03\x12\x04\x92\x01)\
    *\nQ\n\x04\x04\x05\x02\x04\x12\x04\x95\x01\x04$\x1aC\x20Signals\x20clien\
    t\x20to\x20stop\x20connecting\x20for\x20following\x20amount\x20of\x20sec\
    onds\n\n\r\n\x05\x04\x05\x02\x04\x04\x12\x04\x95\x01\x04\x0c\n\r\n\x05\
    \x04\x05\x02\x04\x05\x12\x04\x95\x01\r\x13\n\r\n\x05\x04\x05\x02\x04\x01\
    \x12\x04\x95\x01\x14\x1f\n\r\n\x05\x04\x05\x02\x04\x03\x12\x04\x95\x01\"\
    #\nK\n\x04\x04\x05\x02\x05\x12\x04\x98\x01\x04#\x1a=\x20Sent\x20in\x20SE\
    SSION_INIT,\x20identifies\x20the\x20station\x20that\x20picked\x20up\n\n\
    \r\n\x05\x04\x05\x02\x05\x04\x12\x04\x98\x01\x04\x0c\n\r\n\x05\x04\x05\
    \x02\x05\x05\x12\x04\x98\x01\r\x13\n\r\n\x05\x04\x05\x02\x05\x01\x12\x04\
    \x98\x01\x14\x1e\n\r\n\x05\x04\x05\x02\x05\x03\x12\x04\x98\x01!\"\nG\n\
    \x04\x04\x05\x02\x06\x12\x04\x9b\x01\x04!\x1a9\x20Random-sized\x20junk\
    \x20to\x20defeat\x20packet\x20size\x20fingerprinting.\n\n\r\n\x05\x04\
    \x05\x02\x06\x04\x12\x04\x9b\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x06\x05\
    \x12\x04\x9b\x01\r\x12\n\r\n\x05\x04\x05\x02\x06\x01\x12\x04\x9b\x01\x13\
    \x1a\n\r\n\x05\x04\x05\x02\x06\x03\x12\x04\x9b\x01\x1d\x20\n\x0c\n\x02\
    \x04\x06\x12\x06\x9e\x01\0\xc7\x01\x01\n\x0b\n\x03\x04\x06\x01\x12\x04\
    \x9e\x01\x08\x17\n\x0c\n\x04\x04\x06\x02\0\x12\x04\x9f\x01\x04)\n\r\n\
    \x05\x04\x06\x02\0\x04\x12\x04\x9f\x01\x04\x0c\n\r\n\x05\x04\x06\x02\0\
    \x05\x12\x04\x9f\x01\r\x13\n\r\n\x05\x04\x06\x02\0\x01\x12\x04\x9f\x01\
    \x14$\n\r\n\x05\x04\x06\x02\0\x03\x12\x04\x9f\x01'(\n\xd0\x01\n\x04\x04\
    \x06\x02\x01\x12\x04\xa4\x01\x04.\x1a\xc1\x01\x20The\x20client\x20report\
    s\x20its\x20decoy\x20list's\x20version\x20number\x20here,\x20which\x20th\
    e\n\x20station\x20can\x20use\x20to\x20decide\x20whether\x20to\x20send\
    \x20an\x20updated\x20one.\x20The\x20station\n\x20should\x20always\x20sen\
    d\x20a\x20list\x20if\x20this\x20field\x20is\x20set\x20to\x200.\n\n\r\n\
    \x05\x04\x06\x02\x01\x04\x12\x04\xa4\x01\x04\x0c\n\r\n\x05\x04\x06\x02\
    \x01\x05\x12\x04\xa4\x01\r\x13\n\r\n\x05\x04\x06\x02\x01\x01\x12\x04\xa4\
    \x01\x14)\n\r\n\x05\x04\x06\x02\x01\x03\x12\x04\xa4\x01,-\n\x0c\n\x04\
    \x04\x06\x02\x02\x12\x04\xa6\x01\x041\n\r\n\x05\x04\x06\x02\x02\x04\x12\
    \x04\xa6\x01\x04\x0c\n\r\n\x05\x04\x06\x02\x02\x06\x12\x04\xa6\x01\r\x1b\
    \n\r\n\x05\x04\x06\x02\x02\x01\x12\x04\xa6\x01\x1c,\n\r\n\x05\x04\x06\
    \x02\x02\x03\x12\x04\xa6\x01/0\n\x80\x01\n\x04\x04\x06\x02\x03\x12\x04\
    \xaa\x01\x04$\x1ar\x20The\x20position\x20in\x20the\x20overall\x20session\
    's\x20upload\x20sequence\x20where\x20the\x20current\n\x20YIELD=>ACQUIRE\
    \x20switchover\x20is\x20happening.\n\n\r\n\x05\x04\x06\x02\x03\x04\x12\
    \x04\xaa\x01\x04\x0c\n\r\n\x05\x04\x06\x02\x03\x05\x12\x04\xaa\x01\r\x13\
    \n\r\n\x05\x04\x06\x02\x03\x01\x12\x04\xaa\x01\x14\x1f\n\r\n\x05\x04\x06\
    \x02\x03\x03\x12\x04\xaa\x01\"#\nq\n\x04\x04\x06\x02\x04\x12\x04\xaf\x01\
    \x04'\x1ac\x20List\x20of\x20decoys\x20that\x20client\x20have\x20unsucces\
    sfully\x20tried\x20in\x20current\x20session.\n\x20Could\x20be\x20sent\
    \x20in\x20chunks\n\n\r\n\x05\x04\x06\x02\x04\x04\x12\x04\xaf\x01\x04\x0c\
    \n\r\n\x05\x04\x06\x02\x04\x05\x12\x04\xaf\x01\r\x13\n\r\n\x05\x04\x06\
    \x02\x04\x01\x12\x04\xaf\x01\x14!\n\r\n\x05\x04\x06\x02\x04\x03\x12\x04\
    \xaf\x01$&\n\x0c\n\x04\x04\x06\x02\x05\x12\x04\xb1\x01\x04%\n\r\n\x05\
    \x04\x06\x02\x05\x04\x12\x04\xb1\x01\x04\x0c\n\r\n\x05\x04\x06\x02\x05\
    \x06\x12\x04\xb1\x01\r\x19\n\r\n\x05\x04\x06\x02\x05\x01\x12\x04\xb1\x01\
    \x1a\x1f\n\r\n\x05\x04\x06\x02\x05\x03\x12\x04\xb1\x01\"$\n\xc8\x03\n\
    \x04\x04\x06\x02\x06\x12\x04\xb9\x01\x04(\x1a\xb9\x03\x20Station\x20is\
