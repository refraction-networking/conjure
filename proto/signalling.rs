...
pub struct ClientToStation {
    ...
    client_conf_v: ::std::option::Option<u32>,
...
impl ClientToStation {
    ...
    // optional uint32 client_conf_v = 23;


    pub fn get_client_conf_v(&self) -> u32 {
        self.client_conf_v.unwrap_or(0)
    }
    pub fn clear_client_conf_v(&mut self) {
        self.client_conf_v = ::std::option::Option::None;
    }

    pub fn has_client_conf_v(&self) -> bool {
        self.client_conf_v.is_some()
    }

    // Param is passed by value, moved
    pub fn set_client_conf_v(&mut self, v: u32) {
        self.client_conf_v = ::std::option::Option::Some(v);
    }
...
impl ::protobuf::Message for ClientToStation {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                23 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.client_conf_v = ::std::option::Option::Some(tmp);
                },
                24 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.client_conf_v {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                    "client_conf_v",
                    |m: &ClientToStation| { &m.client_conf_v },
                    |m: &mut ClientToStation| { &mut m.client_conf_v },
                ));
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                    "c2s_protocol",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18d\x20\x01(\x0cR\x07padding\"\x89\x04\n\x0fClientToStation\x12)\n\x10\
    ...
    port\x18\x16\x20\x01(\x08R\tv6Support\x12\"\n\rclient_conf_v\x18\x17\x20\
    \x01(\rR\x0bclientConfV\x12!\n\x0cc2s_protocol\x18\x18\x20\x01(\rR\x0bc2\
    sProtocol\x12\x18\n\x07padding\x18d\x20\x01(\x0cR\x07padding\"\xdd\x01\n\
    ...
    \x05\x12\x11\n\rCLIENT_STREAM\x10d\x12\x12\n\x0eCLIENT_TIMEOUT\x10eJ\xd3\
    E\n\x07\x12\x05\0\0\xd6\x01\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\xb0\
    \x01\n\x01\x02\x12\x03\x06\0\x112\xa5\x01\x20TODO:\x20We're\x20using\x20\
    proto2\x20because\x20it's\x20the\x20default\x20on\x20Ubuntu\x2016.04.\n\
    ...
    \x01\x12\x04\\\0f\x01\x1a!\x20State\x20transitions\x20of\x20the\x20clien\
    ...
    \x03^\x04\x19\"\x15\x20connect\x20me\x20to\x20squid\n\n\x0c\n\x05\x05\
    \x01\x02\x01\x01\x12\x03^\x04\x14\n\x0c\n\x05\x05\x01\x02\x01\x02\x12\
    \x03^\x17\x18\n,\n\x04\x05\x01\x02\x02\x12\x03_\x04!\"\x1f\x20connect\
    \x20me\x20to\x20provided\x20covert\n\n\x0c\n\x05\x05\x01\x02\x02\x01\x12\
    ...
    \x12\x04\xac\x01\"$\n\xc8\x03\n\x04\x04\x05\x02\x06\x12\x04\xb6\x01\x04(\
    ...
    d?\n\n\r\n\x05\x04\x05\x02\x06\x04\x12\x04\xb6\x01\x04\x0c\n\r\n\x05\x04\
    \x05\x02\x06\x05\x12\x04\xb6\x01\r\x13\n\r\n\x05\x04\x05\x02\x06\x01\x12\
    \x04\xb6\x01\x14\"\n\r\n\x05\x04\x05\x02\x06\x03\x12\x04\xb6\x01%'\nR\n\
    \x04\x04\x05\x02\x07\x12\x04\xb9\x01\x042\x1aD\x20Used\x20in\x20dark\x20\
    decoys\x20to\x20signal\x20which\x20dark\x20decoy\x20it\x20will\x20connec\
    t\x20to.\n\n\r\n\x05\x04\x05\x02\x07\x04\x12\x04\xb9\x01\x04\x0c\n\r\n\
    \x05\x04\x05\x02\x07\x05\x12\x04\xb9\x01\r\x13\n\r\n\x05\x04\x05\x02\x07\
    \x01\x12\x04\xb9\x01\x14,\n\r\n\x05\x04\x05\x02\x07\x03\x12\x04\xb9\x01/\
    1\nk\n\x04\x04\x05\x02\x08\x12\x04\xbc\x01\x04\"\x1a]\x20Used\x20to\x20i\
    ndicate\x20to\x20server\x20if\x20client\x20doesn't\x20support\x20ipv6\
    \x20for\x20dark\x20decoy\x20address\x20selection.\n\n\r\n\x05\x04\x05\
    \x02\x08\x04\x12\x04\xbc\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x08\x05\x12\
    \x04\xbc\x01\r\x11\n\r\n\x05\x04\x05\x02\x08\x01\x12\x04\xbc\x01\x12\x1c\
    \n\r\n\x05\x04\x05\x02\x08\x03\x12\x04\xbc\x01\x1f!\ng\n\x04\x04\x05\x02\
    \t\x12\x04\xbf\x01\x04'\x1aY\x20Client\x20Conf\x20version\x20->\x20used\
    \x20to\x20signal\x20to\x20the\x20station\x20what\x20decoy\x20ip\x20block\
    s\x20are\x20supported\n\n\r\n\x05\x04\x05\x02\t\x04\x12\x04\xbf\x01\x04\
    \x0c\n\r\n\x05\x04\x05\x02\t\x05\x12\x04\xbf\x01\r\x13\n\r\n\x05\x04\x05\
    \x02\t\x01\x12\x04\xbf\x01\x14!\n\r\n\x05\x04\x05\x02\t\x03\x12\x04\xbf\
    \x01$&\nI\n\x04\x04\x05\x02\n\x12\x04\xc2\x01\x04&\x1a;\x20Protocol\x20T\
    ype\x20->\x20protocol\x20used\x20in\x20client\x20to\x20proxy\x20station\
    \n\n\r\n\x05\x04\x05\x02\n\x04\x12\x04\xc2\x01\x04\x0c\n\r\n\x05\x04\x05\
    \x02\n\x05\x12\x04\xc2\x01\r\x13\n\r\n\x05\x04\x05\x02\n\x01\x12\x04\xc2\
    \x01\x14\x20\n\r\n\x05\x04\x05\x02\n\x03\x12\x04\xc2\x01#%\nG\n\x04\x04\
    \x05\x02\x0b\x12\x04\xc7\x01\x04!\x1a9\x20Random-sized\x20junk\x20to\x20\
    defeat\x20packet\x20size\x20fingerprinting.\n\n\r\n\x05\x04\x05\x02\x0b\
    \x04\x12\x04\xc7\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x0b\x05\x12\x04\xc7\
    \x01\r\x12\n\r\n\x05\x04\x05\x02\x0b\x01\x12\x04\xc7\x01\x13\x1a\n\r\n\
    \x05\x04\x05\x02\x0b\x03\x12\x04\xc7\x01\x1d\x20\n\x0c\n\x02\x04\x06\x12\
    \x06\xca\x01\0\xd6\x01\x01\n\x0b\n\x03\x04\x06\x01\x12\x04\xca\x01\x08\
    \x14\n9\n\x04\x04\x06\x02\0\x12\x04\xcb\x01\x04.\"+\x20how\x20many\x20de\
    coys\x20were\x20tried\x20before\x20success\n\n\r\n\x05\x04\x06\x02\0\x04\
    \x12\x04\xcb\x01\x04\x0c\n\r\n\x05\x04\x06\x02\0\x05\x12\x04\xcb\x01\r\
    \x13\n\r\n\x05\x04\x06\x02\0\x01\x12\x04\xcb\x01\x14(\n\r\n\x05\x04\x06\
    \x02\0\x03\x12\x04\xcb\x01+-\nm\n\x04\x04\x06\x02\x01\x12\x04\xd0\x01\
    \x04/\x1a\x1e\x20Applicable\x20to\x20whole\x20session:\n\"\x1a\x20includ\
    es\x20failed\x20attempts\n2#\x20Timings\x20below\x20are\x20in\x20millise\
    conds\n\n\r\n\x05\x04\x06\x02\x01\x04\x12\x04\xd0\x01\x04\x0c\n\r\n\x05\
    \x04\x06\x02\x01\x05\x12\x04\xd0\x01\r\x13\n\r\n\x05\x04\x06\x02\x01\x01\
    \x12\x04\xd0\x01\x14)\n\r\n\x05\x04\x06\x02\x01\x03\x12\x04\xd0\x01,.\nR\
    \n\x04\x04\x06\x02\x02\x12\x04\xd3\x01\x04(\x1a\x1f\x20Last\x20(i.e.\x20\
    successful)\x20decoy:\n\"#\x20measured\x20during\x20initial\x20handshake\
    \n\n\r\n\x05\x04\x06\x02\x02\x04\x12\x04\xd3\x01\x04\x0c\n\r\n\x05\x04\
    \x06\x02\x02\x05\x12\x04\xd3\x01\r\x13\n\r\n\x05\x04\x06\x02\x02\x01\x12\
    \x04\xd3\x01\x14\"\n\r\n\x05\x04\x06\x02\x02\x03\x12\x04\xd3\x01%'\n%\n\
    \x04\x04\x06\x02\x03\x12\x04\xd4\x01\x04&\"\x17\x20includes\x20tcp\x20to\
    \x20decoy\n\n\r\n\x05\x04\x06\x02\x03\x04\x12\x04\xd4\x01\x04\x0c\n\r\n\
    \x05\x04\x06\x02\x03\x05\x12\x04\xd4\x01\r\x13\n\r\n\x05\x04\x06\x02\x03\
    \x01\x12\x04\xd4\x01\x14\x20\n\r\n\x05\x04\x06\x02\x03\x03\x12\x04\xd4\
    \x01#%\nB\n\x04\x04\x06\x02\x04\x12\x04\xd5\x01\x04&\"4\x20measured\x20w\
    hen\x20establishing\x20tcp\x20connection\x20to\x20decot\n\n\r\n\x05\x04\
    \x06\x02\x04\x04\x12\x04\xd5\x01\x04\x0c\n\r\n\x05\x04\x06\x02\x04\x05\
    \x12\x04\xd5\x01\r\x13\n\r\n\x05\x04\x06\x02\x04\x01\x12\x04\xd5\x01\x14\
    \x20\n\r\n\x05\x04\x06\x02\x04\x03\x12\x04\xd5\x01#%\
";
