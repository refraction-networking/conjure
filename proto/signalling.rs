...
pub struct WebrtcSDP {
    // message fields
    sdp_type: ::std::option::Option<u32>,
...
impl WebrtcSDP {
    ...
    // optional uint32 sdp_type = 1;


    pub fn get_sdp_type(&self) -> u32 {
        self.sdp_type.unwrap_or(0)
    }
    pub fn clear_sdp_type(&mut self) {
        self.sdp_type = ::std::option::Option::None;
    }

    pub fn has_sdp_type(&self) -> bool {
        self.sdp_type.is_some()
    }

    // Param is passed by value, moved
    pub fn set_sdp_type(&mut self, v: u32) {
        self.sdp_type = ::std::option::Option::Some(v);
    }

    // optional uint64 ip_upper = 2;
...
impl ::protobuf::Message for WebrtcSDP {
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.sdp_type = ::std::option::Option::Some(tmp);
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "sdp_type",
                |m: &WebrtcSDP| { &m.sdp_type },
                |m: &mut WebrtcSDP| { &mut m.sdp_type },
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                "ip_upper",
                |m: &WebrtcSDP| { &m.ip_upper },
                |m: &mut WebrtcSDP| { &mut m.ip_upper },
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                "ip_lower",
                |m: &WebrtcSDP| { &m.ip_lower },
                |m: &mut WebrtcSDP| { &mut m.ip_lower },
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "composed_info",
                |m: &WebrtcSDP| { &m.composed_info },
                |m: &mut WebrtcSDP| { &mut m.composed_info },
            ));
...
#[derive(PartialEq,Clone,Default)]
pub struct WebrtcSignalling {
    // message fields
    pub webrtc_sdps: ::protobuf::RepeatedField<WebrtcSDP>,
    webrtc_seed: ::protobuf::SingularField<::std::string::String>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a WebrtcSignalling {
    fn default() -> &'a WebrtcSignalling {
        <WebrtcSignalling as ::protobuf::Message>::default_instance()
    }
}

impl WebrtcSignalling {
    pub fn new() -> WebrtcSignalling {
        ::std::default::Default::default()
    }

    // repeated .tapdance.WebrtcSDP webrtc_sdps = 1;


    pub fn get_webrtc_sdps(&self) -> &[WebrtcSDP] {
        &self.webrtc_sdps
    }
    pub fn clear_webrtc_sdps(&mut self) {
        self.webrtc_sdps.clear();
    }

    // Param is passed by value, moved
    pub fn set_webrtc_sdps(&mut self, v: ::protobuf::RepeatedField<WebrtcSDP>) {
        self.webrtc_sdps = v;
    }

    // Mutable pointer to the field.
    pub fn mut_webrtc_sdps(&mut self) -> &mut ::protobuf::RepeatedField<WebrtcSDP> {
        &mut self.webrtc_sdps
    }

    // Take field
    pub fn take_webrtc_sdps(&mut self) -> ::protobuf::RepeatedField<WebrtcSDP> {
        ::std::mem::replace(&mut self.webrtc_sdps, ::protobuf::RepeatedField::new())
    }

    // optional string webrtc_seed = 2;


    pub fn get_webrtc_seed(&self) -> &str {
        match self.webrtc_seed.as_ref() {
            Some(v) => &v,
            None => "",
        }
    }
    pub fn clear_webrtc_seed(&mut self) {
        self.webrtc_seed.clear();
    }

    pub fn has_webrtc_seed(&self) -> bool {
        self.webrtc_seed.is_some()
    }

    // Param is passed by value, moved
    pub fn set_webrtc_seed(&mut self, v: ::std::string::String) {
        self.webrtc_seed = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_webrtc_seed(&mut self) -> &mut ::std::string::String {
        if self.webrtc_seed.is_none() {
            self.webrtc_seed.set_default();
        }
        self.webrtc_seed.as_mut().unwrap()
    }

    // Take field
    pub fn take_webrtc_seed(&mut self) -> ::std::string::String {
        self.webrtc_seed.take().unwrap_or_else(|| ::std::string::String::new())
    }
}

impl ::protobuf::Message for WebrtcSignalling {
    fn is_initialized(&self) -> bool {
        for v in &self.webrtc_sdps {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.webrtc_sdps)?;
                },
                2 => {
                    ::protobuf::rt::read_singular_string_into(wire_type, is, &mut self.webrtc_seed)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in &self.webrtc_sdps {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        if let Some(ref v) = self.webrtc_seed.as_ref() {
    ...
    fn new() -> WebrtcSignalling {
        WebrtcSignalling::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<WebrtcSDP>>(
                "webrtc_sdps",
                |m: &WebrtcSignalling| { &m.webrtc_sdps },
                |m: &mut WebrtcSignalling| { &mut m.webrtc_sdps },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "webrtc_seed",
                |m: &WebrtcSignalling| { &m.webrtc_seed },
                |m: &mut WebrtcSignalling| { &mut m.webrtc_seed },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<WebrtcSignalling>(
                "WebrtcSignalling",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static WebrtcSignalling {
        static instance: ::protobuf::rt::LazyV2<WebrtcSignalling> = ::protobuf::rt::LazyV2::INIT;
        instance.get(WebrtcSignalling::new)
    }
}

impl ::protobuf::Clear for WebrtcSignalling {
    fn clear(&mut self) {
        self.webrtc_sdps.clear();
        self.webrtc_seed.clear();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for WebrtcSignalling {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for WebrtcSignalling {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
pub struct ClientToStation {
    ...
    pub webrtc_signalling: ::protobuf::SingularPtrField<WebrtcSignalling>,
    padding: ::protobuf::SingularField<::std::vec::Vec<u8>>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
...
impl ClientToStation {
    ...
    // optional .tapdance.WebrtcSignalling webrtc_signalling = 31;


    pub fn get_webrtc_signalling(&self) -> &WebrtcSignalling {
        self.webrtc_signalling.as_ref().unwrap_or_else(|| <WebrtcSignalling as ::protobuf::Message>::default_instance())
    }
    pub fn clear_webrtc_signalling(&mut self) {
        self.webrtc_signalling.clear();
    }

    pub fn has_webrtc_signalling(&self) -> bool {
        self.webrtc_signalling.is_some()
    }

    // Param is passed by value, moved
    pub fn set_webrtc_signalling(&mut self, v: WebrtcSignalling) {
        self.webrtc_signalling = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_webrtc_signalling(&mut self) -> &mut WebrtcSignalling {
        if self.webrtc_signalling.is_none() {
            self.webrtc_signalling.set_default();
        }
        self.webrtc_signalling.as_mut().unwrap()
    }

    // Take field
    pub fn take_webrtc_signalling(&mut self) -> WebrtcSignalling {
        self.webrtc_signalling.take().unwrap_or_else(|| WebrtcSignalling::new())
    }
...
impl ::protobuf::Message for ClientToStation {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.webrtc_signalling {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                31 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.webrtc_signalling)?;
                },
                100 => {
                    ::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.padding)?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.webrtc_signalling.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        if let Some(ref v) = self.padding.as_ref() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<WebrtcSignalling>>(
                "webrtc_signalling",
                |m: &ClientToStation| { &m.webrtc_signalling },
                |m: &mut ClientToStation| { &mut m.webrtc_signalling },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                "padding",
...
impl ::protobuf::ProtobufEnum for TransportType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<TransportType> {
        match value {
            ...
            3 => ::std::option::Option::Some(TransportType::Webrtc),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \tR\x07subnets\"\x81\x01\n\tWebrtcSDP\x12\x19\n\x08sdp_type\x18\x01\x20\
    \x01(\rR\x07sdpType\x12\x19\n\x08ip_upper\x18\x02\x20\x01(\x04R\x07ipUpp\
    er\x12\x19\n\x08ip_lower\x18\x03\x20\x01(\x04R\x07ipLower\x12#\n\rcompos\
    ed_info\x18\x04\x20\x01(\rR\x0ccomposedInfo\"i\n\x10WebrtcSignalling\x12\
    4\n\x0bwebrtc_sdps\x18\x01\x20\x03(\x0b2\x13.tapdance.WebrtcSDPR\nwebrtc\
    Sdps\x12\x1f\n\x0bwebrtc_seed\x18\x02\x20\x01(\tR\nwebrtcSeed\"\xcb\x02\
    \n\x0fStationToClient\x12)\n\x10protocol_version\x18\x01\x20\x01(\rR\x0f\
    protocolVersion\x12C\n\x10state_transition\x18\x02\x20\x01(\x0e2\x18.tap\
    dance.S2C_TransitionR\x0fstateTransition\x125\n\x0bconfig_info\x18\x03\
    \x20\x01(\x0b2\x14.tapdance.ClientConfR\nconfigInfo\x127\n\nerr_reason\
    \x18\x04\x20\x01(\x0e2\x18.tapdance.ErrorReasonS2CR\terrReason\x12\x1f\n\
    ...
    ,\n\x05stats\x18\x0b\x20\x01(\x0b2\x16.tapdance.SessionStatsR\x05stats\
    \x125\n\ttransport\x18\x0c\x20\x01(\x0e2\x17.tapdance.TransportTypeR\ttr\
    ansport\x12%\n\x0ecovert_address\x18\x14\x20\x01(\tR\rcovertAddress\x127\
    \n\x18masked_decoy_server_name\x18\x15\x20\x01(\tR\x15maskedDecoyServerN\
    ame\x12\x1d\n\nv6_support\x18\x16\x20\x01(\x08R\tv6Support\x12\x1d\n\nv4\
    _support\x18\x17\x20\x01(\x08R\tv4Support\x121\n\x05flags\x18\x18\x20\
    \x01(\x0b2\x1b.tapdance.RegistrationFlagsR\x05flags\x12G\n\x11webrtc_sig\
    nalling\x18\x1f\x20\x01(\x0b2\x1a.tapdance.WebrtcSignallingR\x10webrtcSi\
    gnalling\x12\x18\n\x07padding\x18d\x20\x01(\x0cR\x07padding\"\xa6\x02\n\
    \nC2SWrapper\x12#\n\rshared_secret\x18\x01\x20\x01(\x0cR\x0csharedSecret\
    \x12L\n\x14registration_payload\x18\x03\x20\x01(\x0b2\x19.tapdance.Clien\
    tToStationR\x13registrationPayload\x12M\n\x13registration_source\x18\x04\
    \x20\x01(\x0e2\x1c.tapdance.RegistrationSourceR\x12registrationSource\
    \x121\n\x14registration_address\x18\x06\x20\x01(\x0cR\x13registrationAdd\
    ress\x12#\n\rdecoy_address\x18\x07\x20\x01(\x0cR\x0cdecoyAddress\"\xdd\
    \x01\n\x0cSessionStats\x120\n\x14failed_decoys_amount\x18\x14\x20\x01(\r\
    R\x12failedDecoysAmount\x121\n\x15total_time_to_connect\x18\x1f\x20\x01(\
    \rR\x12totalTimeToConnect\x12$\n\x0ertt_to_station\x18!\x20\x01(\rR\x0cr\
    ttToStation\x12\x20\n\x0ctls_to_decoy\x18&\x20\x01(\rR\ntlsToDecoy\x12\
    \x20\n\x0ctcp_to_decoy\x18'\x20\x01(\rR\ntcpToDecoy\"n\n\x11StationToDet\
    ector\x12\x1d\n\nphantom_ip\x18\x01\x20\x01(\tR\tphantomIp\x12\x1b\n\tcl\
    ient_ip\x18\x02\x20\x01(\tR\x08clientIp\x12\x1d\n\ntimeout_ns\x18\x03\
    \x20\x01(\x04R\ttimeoutNs*+\n\x07KeyType\x12\x0f\n\x0bAES_GCM_128\x10Z\
    \x12\x0f\n\x0bAES_GCM_256\x10[*\xe7\x01\n\x0eC2S_Transition\x12\x11\n\rC\
    2S_NO_CHANGE\x10\0\x12\x14\n\x10C2S_SESSION_INIT\x10\x01\x12\x1b\n\x17C2\
    S_SESSION_COVERT_INIT\x10\x0b\x12\x18\n\x14C2S_EXPECT_RECONNECT\x10\x02\
    \x12\x15\n\x11C2S_SESSION_CLOSE\x10\x03\x12\x14\n\x10C2S_YIELD_UPLOAD\
    \x10\x04\x12\x16\n\x12C2S_ACQUIRE_UPLOAD\x10\x05\x12\x20\n\x1cC2S_EXPECT\
    _UPLOADONLY_RECONN\x10\x06\x12\x0e\n\tC2S_ERROR\x10\xff\x01*\x98\x01\n\
    \x0eS2C_Transition\x12\x11\n\rS2C_NO_CHANGE\x10\0\x12\x14\n\x10S2C_SESSI\
    ON_INIT\x10\x01\x12\x1b\n\x17S2C_SESSION_COVERT_INIT\x10\x0b\x12\x19\n\
    \x15S2C_CONFIRM_RECONNECT\x10\x02\x12\x15\n\x11S2C_SESSION_CLOSE\x10\x03\
    \x12\x0e\n\tS2C_ERROR\x10\xff\x01*\xac\x01\n\x0eErrorReasonS2C\x12\x0c\n\
    \x08NO_ERROR\x10\0\x12\x11\n\rCOVERT_STREAM\x10\x01\x12\x13\n\x0fCLIENT_\
    REPORTED\x10\x02\x12\x13\n\x0fCLIENT_PROTOCOL\x10\x03\x12\x14\n\x10STATI\
    ON_INTERNAL\x10\x04\x12\x12\n\x0eDECOY_OVERLOAD\x10\x05\x12\x11\n\rCLIEN\
    T_STREAM\x10d\x12\x12\n\x0eCLIENT_TIMEOUT\x10e*9\n\rTransportType\x12\
    \x08\n\x04Null\x10\0\x12\x07\n\x03Min\x10\x01\x12\t\n\x05Obfs4\x10\x02\
    \x12\n\n\x06Webrtc\x10\x03*Q\n\x12RegistrationSource\x12\x0f\n\x0bUnspec\
    ified\x10\0\x12\x0c\n\x08Detector\x10\x01\x12\x07\n\x03API\x10\x02\x12\
    \x13\n\x0fDetectorPrescan\x10\x03J\x90\\\n\x07\x12\x05\0\0\x98\x02\x01\n\
    ...
    \x18\n\x0c\n\x02\x05\x04\x12\x06\x8b\x01\0\x90\x01\x01\n\x0b\n\x03\x05\
    ...
    \x8e\x01\x0c\r\n1\n\x04\x05\x04\x02\x03\x12\x04\x8f\x01\x04\x0f\"#\x20UD\
    P\x20transport:\x20WebRTC\x20DataChannel\n\n\r\n\x05\x05\x04\x02\x03\x01\
    \x12\x04\x8f\x01\x04\n\n\r\n\x05\x05\x04\x02\x03\x02\x12\x04\x8f\x01\r\
    \x20Should\x20accompany\x20(at\x20least)\x20SESSION_INIT\x20and\x20CONFI\
    RM_RECONNECT.\n\n\r\n\x05\x04\x08\x02\0\x04\x12\x04\xa1\x01\x04\x0c\n\r\
    \n\x05\x04\x08\x02\0\x05\x12\x04\xa1\x01\r\x13\n\r\n\x05\x04\x08\x02\0\
    \x01\x12\x04\xa1\x01\x14$\n\r\n\x05\x04\x08\x02\0\x03\x12\x04\xa1\x01'(\
    \nv\n\x04\x04\x08\x02\x01\x12\x04\xa5\x01\x041\x1ah\x20There\x20might\
    \x20be\x20a\x20state\x20transition.\x20May\x20be\x20absent;\x20absence\
    \x20should\x20be\n\x20treated\x20identically\x20to\x20NO_CHANGE.\n\n\r\n\
    \x05\x04\x08\x02\x01\x04\x12\x04\xa5\x01\x04\x0c\n\r\n\x05\x04\x08\x02\
    \x01\x06\x12\x04\xa5\x01\r\x1b\n\r\n\x05\x04\x08\x02\x01\x01\x12\x04\xa5\
    \x01\x1c,\n\r\n\x05\x04\x08\x02\x01\x03\x12\x04\xa5\x01/0\nc\n\x04\x04\
    \x08\x02\x02\x12\x04\xa9\x01\x04(\x1aU\x20The\x20station\x20can\x20send\
    \x20client\x20config\x20info\x20piggybacked\n\x20on\x20any\x20message,\
    \x20as\x20it\x20sees\x20fit\n\n\r\n\x05\x04\x08\x02\x02\x04\x12\x04\xa9\
    \x01\x04\x0c\n\r\n\x05\x04\x08\x02\x02\x06\x12\x04\xa9\x01\r\x17\n\r\n\
    \x05\x04\x08\x02\x02\x01\x12\x04\xa9\x01\x18#\n\r\n\x05\x04\x08\x02\x02\
    \x03\x12\x04\xa9\x01&'\nP\n\x04\x04\x08\x02\x03\x12\x04\xac\x01\x04+\x1a\
    B\x20If\x20state_transition\x20==\x20S2C_ERROR,\x20this\x20field\x20is\
    \x20the\x20explanation.\n\n\r\n\x05\x04\x08\x02\x03\x04\x12\x04\xac\x01\
    \x04\x0c\n\r\n\x05\x04\x08\x02\x03\x06\x12\x04\xac\x01\r\x1b\n\r\n\x05\
    \x04\x08\x02\x03\x01\x12\x04\xac\x01\x1c&\n\r\n\x05\x04\x08\x02\x03\x03\
    \x12\x04\xac\x01)*\nQ\n\x04\x04\x08\x02\x04\x12\x04\xaf\x01\x04$\x1aC\
    \x20Signals\x20client\x20to\x20stop\x20connecting\x20for\x20following\
    \x20amount\x20of\x20seconds\n\n\r\n\x05\x04\x08\x02\x04\x04\x12\x04\xaf\
    \x01\x04\x0c\n\r\n\x05\x04\x08\x02\x04\x05\x12\x04\xaf\x01\r\x13\n\r\n\
    \x05\x04\x08\x02\x04\x01\x12\x04\xaf\x01\x14\x1f\n\r\n\x05\x04\x08\x02\
    \x04\x03\x12\x04\xaf\x01\"#\nK\n\x04\x04\x08\x02\x05\x12\x04\xb2\x01\x04\
    #\x1a=\x20Sent\x20in\x20SESSION_INIT,\x20identifies\x20the\x20station\
    \x20that\x20picked\x20up\n\n\r\n\x05\x04\x08\x02\x05\x04\x12\x04\xb2\x01\
    \xd3\x01\x1a\x1f\n\r\n\x05\x04\n\x02\x05\x03\x12\x04\xd3\x01\"$\nk\n\x04\
    \x04\n\x02\x06\x12\x04\xd6\x01\x04*\x1a]\x20NullTransport,\x20MinTranspo\
    rt,\x20Obfs4Transport,\x20etc.\x20Transport\x20type\x20we\x20want\x20fro\
    m\x20phantom\x20proxy\n\n\r\n\x05\x04\n\x02\x06\x04\x12\x04\xd6\x01\x04\
    \x0c\n\r\n\x05\x04\n\x02\x06\x06\x12\x04\xd6\x01\r\x1a\n\r\n\x05\x04\n\
    \x02\x06\x01\x12\x04\xd6\x01\x1b$\n\r\n\x05\x04\n\x02\x06\x03\x12\x04\
    \xd6\x01')\n\xc8\x03\n\x04\x04\n\x02\x07\x12\x04\xde\x01\x04(\x1a\xb9\
    ...
    \r\n\x05\x04\n\x02\x07\x04\x12\x04\xde\x01\x04\x0c\n\r\n\x05\x04\n\x02\
    \x07\x05\x12\x04\xde\x01\r\x13\n\r\n\x05\x04\n\x02\x07\x01\x12\x04\xde\
    \x01\x14\"\n\r\n\x05\x04\n\x02\x07\x03\x12\x04\xde\x01%'\nR\n\x04\x04\n\
    \x02\x08\x12\x04\xe1\x01\x042\x1aD\x20Used\x20in\x20dark\x20decoys\x20to\
    \x20signal\x20which\x20dark\x20decoy\x20it\x20will\x20connect\x20to.\n\n\
    \r\n\x05\x04\n\x02\x08\x04\x12\x04\xe1\x01\x04\x0c\n\r\n\x05\x04\n\x02\
    \x08\x05\x12\x04\xe1\x01\r\x13\n\r\n\x05\x04\n\x02\x08\x01\x12\x04\xe1\
    \x01\x14,\n\r\n\x05\x04\n\x02\x08\x03\x12\x04\xe1\x01/1\nR\n\x04\x04\n\
    \x02\t\x12\x04\xe4\x01\x04\"\x1aD\x20Used\x20to\x20indicate\x20to\x20ser\
    ver\x20if\x20client\x20is\x20registering\x20v4,\x20v6\x20or\x20both\n\n\
    \r\n\x05\x04\n\x02\t\x04\x12\x04\xe4\x01\x04\x0c\n\r\n\x05\x04\n\x02\t\
    \x05\x12\x04\xe4\x01\r\x11\n\r\n\x05\x04\n\x02\t\x01\x12\x04\xe4\x01\x12\
    \x1c\n\r\n\x05\x04\n\x02\t\x03\x12\x04\xe4\x01\x1f!\n\x0c\n\x04\x04\n\
    \x02\n\x12\x04\xe5\x01\x04\"\n\r\n\x05\x04\n\x02\n\x04\x12\x04\xe5\x01\
    \x04\x0c\n\r\n\x05\x04\n\x02\n\x05\x12\x04\xe5\x01\r\x11\n\r\n\x05\x04\n\
    \x02\n\x01\x12\x04\xe5\x01\x12\x1c\n\r\n\x05\x04\n\x02\n\x03\x12\x04\xe5\
    \x01\x1f!\nD\n\x04\x04\n\x02\x0b\x12\x04\xe8\x01\x08.\x1a6\x20A\x20colle\
    ction\x20of\x20optional\x20flags\x20for\x20the\x20registration.\n\n\r\n\
    \x05\x04\n\x02\x0b\x04\x12\x04\xe8\x01\x08\x10\n\r\n\x05\x04\n\x02\x0b\
