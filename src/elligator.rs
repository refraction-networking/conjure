...
mod tests {
    ...
    const REGTLSPAYLOAD: &str = "";
    const SHAREDSECRET: &str = "c41ce05bf8480df3ef038dc9747fa608375a7ab64d8938e30a27e9e222ae680d";
    ...
    fn test_extract_payload() {
        ...
        let res =
            elligator::extract_payloads(&privkey, &tls_record).expect("err extracting paylaod");
        let shared_secret = res.0.to_vec();
        let correct_shared_secret = hex::decode(SHAREDSECRET).expect("err decoding shared secret");
        assert_eq!(shared_secret, correct_shared_secret);
    }
