...
pub struct ClientToStation {
    ...
    c2s_protocol: ::std::option::Option<u32>,
    padding: ::protobuf::SingularField<::std::vec::Vec<u8>>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
...
impl ClientToStation {
    ...
    // optional uint32 c2s_protocol = 24;


    pub fn get_c2s_protocol(&self) -> u32 {
        self.c2s_protocol.unwrap_or(0)
    }
    pub fn clear_c2s_protocol(&mut self) {
        self.c2s_protocol = ::std::option::Option::None;
    }

    pub fn has_c2s_protocol(&self) -> bool {
        self.c2s_protocol.is_some()
    }

    // Param is passed by value, moved
    pub fn set_c2s_protocol(&mut self, v: u32) {
        self.c2s_protocol = ::std::option::Option::Some(v);
    }
...
impl ::protobuf::Message for ClientToStation {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                24 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.c2s_protocol = ::std::option::Option::Some(tmp);
                },
                100 => {
                    ::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.padding)?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.c2s_protocol {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                    "c2s_protocol",
                    |m: &ClientToStation| { &m.c2s_protocol },
                    |m: &mut ClientToStation| { &mut m.c2s_protocol },
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "padding",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\n\x07padding\x18d\x20\x01(\x0cR\x07padding\"\xe5\x03\n\x0fClientToS\
    ...
    e\x12\x1d\n\nv6_support\x18\x16\x20\x01(\x08R\tv6Support\x12!\n\x0cc2s_p\
    rotocol\x18\x18\x20\x01(\rR\x0bc2sProtocol\x12\x18\n\x07padding\x18d\x20\
    \x01(\x0cR\x07padding\"\xdd\x01\n\x0cSessionStats\x120\n\x14failed_decoy\
    s_amount\x18\x14\x20\x01(\rR\x12failedDecoysAmount\x121\n\x15total_time_\
    to_connect\x18\x1f\x20\x01(\rR\x12totalTimeToConnect\x12$\n\x0ertt_to_st\
    ation\x18!\x20\x01(\rR\x0crttToStation\x12\x20\n\x0ctls_to_decoy\x18&\
    \x20\x01(\rR\ntlsToDecoy\x12\x20\n\x0ctcp_to_decoy\x18'\x20\x01(\rR\ntcp\
    ToDecoy*+\n\x07KeyType\x12\x0f\n\x0bAES_GCM_128\x10Z\x12\x0f\n\x0bAES_GC\
    M_256\x10[*\xe7\x01\n\x0eC2S_Transition\x12\x11\n\rC2S_NO_CHANGE\x10\0\
    \x12\x14\n\x10C2S_SESSION_INIT\x10\x01\x12\x1b\n\x17C2S_SESSION_COVERT_I\
    NIT\x10\x0b\x12\x18\n\x14C2S_EXPECT_RECONNECT\x10\x02\x12\x15\n\x11C2S_S\
    ESSION_CLOSE\x10\x03\x12\x14\n\x10C2S_YIELD_UPLOAD\x10\x04\x12\x16\n\x12\
    C2S_ACQUIRE_UPLOAD\x10\x05\x12\x20\n\x1cC2S_EXPECT_UPLOADONLY_RECONN\x10\
    \x06\x12\x0e\n\tC2S_ERROR\x10\xff\x01*\x98\x01\n\x0eS2C_Transition\x12\
    \x11\n\rS2C_NO_CHANGE\x10\0\x12\x14\n\x10S2C_SESSION_INIT\x10\x01\x12\
    \x1b\n\x17S2C_SESSION_COVERT_INIT\x10\x0b\x12\x19\n\x15S2C_CONFIRM_RECON\
    NECT\x10\x02\x12\x15\n\x11S2C_SESSION_CLOSE\x10\x03\x12\x0e\n\tS2C_ERROR\
    ...
    \x02\x04\x02\x12\x04Q\0V\x012\xf6\x07\x20In\x20version\x201,\x20the\x20r\
    ...
    \x04a\0k\x01\x1a!\x20State\x20transitions\x20of\x20the\x20client\n\n\n\n\
    \x03\x05\x01\x01\x12\x03a\x05\x13\n\x0b\n\x04\x05\x01\x02\0\x12\x03b\x04\
    \x16\n\x0c\n\x05\x05\x01\x02\0\x01\x12\x03b\x04\x11\n\x0c\n\x05\x05\x01\
    \x02\0\x02\x12\x03b\x14\x15\n\"\n\x04\x05\x01\x02\x01\x12\x03c\x04\x19\"\
    \x15\x20connect\x20me\x20to\x20squid\n\n\x0c\n\x05\x05\x01\x02\x01\x01\
    \x12\x03c\x04\x14\n\x0c\n\x05\x05\x01\x02\x01\x02\x12\x03c\x17\x18\n,\n\
    \x04\x05\x01\x02\x02\x12\x03d\x04!\"\x1f\x20connect\x20me\x20to\x20provi\
    ...
    *\nQ\n\x04\x04\x05\x02\x04\x12\x04\x95\x01\x04$\x1aC\x20Signals\x20clien\
    ...
    \x04\x06\x12\x06\x9e\x01\0\xc9\x01\x01\n\x0b\n\x03\x04\x06\x01\x12\x04\
    ...
    \x04\x04\x06\x02\x06\x12\x04\xbb\x01\x04(\x1a\xb9\x03\x20Station\x20is\
    ...
    \x06\x04\x12\x04\xbb\x01\x04\x0c\n\r\n\x05\x04\x06\x02\x06\x05\x12\x04\
    \xbb\x01\r\x13\n\r\n\x05\x04\x06\x02\x06\x01\x12\x04\xbb\x01\x14\"\n\r\n\
    \x05\x04\x06\x02\x06\x03\x12\x04\xbb\x01%'\nR\n\x04\x04\x06\x02\x07\x12\
    \x04\xbe\x01\x042\x1aD\x20Used\x20in\x20dark\x20decoys\x20to\x20signal\
    \x20which\x20dark\x20decoy\x20it\x20will\x20connect\x20to.\n\n\r\n\x05\
    \x04\x06\x02\x07\x04\x12\x04\xbe\x01\x04\x0c\n\r\n\x05\x04\x06\x02\x07\
    \x05\x12\x04\xbe\x01\r\x13\n\r\n\x05\x04\x06\x02\x07\x01\x12\x04\xbe\x01\
    \x14,\n\r\n\x05\x04\x06\x02\x07\x03\x12\x04\xbe\x01/1\nk\n\x04\x04\x06\
    \x02\x08\x12\x04\xc1\x01\x04\"\x1a]\x20Used\x20to\x20indicate\x20to\x20s\
    erver\x20if\x20client\x20doesn't\x20support\x20ipv6\x20for\x20dark\x20de\
    coy\x20address\x20selection.\n\n\r\n\x05\x04\x06\x02\x08\x04\x12\x04\xc1\
    \x01\x04\x0c\n\r\n\x05\x04\x06\x02\x08\x05\x12\x04\xc1\x01\r\x11\n\r\n\
    \x05\x04\x06\x02\x08\x01\x12\x04\xc1\x01\x12\x1c\n\r\n\x05\x04\x06\x02\
    \x08\x03\x12\x04\xc1\x01\x1f!\nI\n\x04\x04\x06\x02\t\x12\x04\xc4\x01\x04\
    &\x1a;\x20Protocol\x20Type\x20->\x20protocol\x20used\x20in\x20client\x20\
    to\x20proxy\x20station\n\n\r\n\x05\x04\x06\x02\t\x04\x12\x04\xc4\x01\x04\
    \x0c\n\r\n\x05\x04\x06\x02\t\x05\x12\x04\xc4\x01\r\x13\n\r\n\x05\x04\x06\
    \x02\t\x01\x12\x04\xc4\x01\x14\x20\n\r\n\x05\x04\x06\x02\t\x03\x12\x04\
    \xc4\x01#%\nG\n\x04\x04\x06\x02\n\x12\x04\xc8\x01\x04!\x1a9\x20Random-si\
    zed\x20junk\x20to\x20defeat\x20packet\x20size\x20fingerprinting.\n\n\r\n\
    \x05\x04\x06\x02\n\x04\x12\x04\xc8\x01\x04\x0c\n\r\n\x05\x04\x06\x02\n\
    \x05\x12\x04\xc8\x01\r\x12\n\r\n\x05\x04\x06\x02\n\x01\x12\x04\xc8\x01\
    \x13\x1a\n\r\n\x05\x04\x06\x02\n\x03\x12\x04\xc8\x01\x1d\x20\n\x0c\n\x02\
    \x04\x07\x12\x06\xcb\x01\0\xd7\x01\x01\n\x0b\n\x03\x04\x07\x01\x12\x04\
    \xcb\x01\x08\x14\n9\n\x04\x04\x07\x02\0\x12\x04\xcc\x01\x04.\"+\x20how\
    \x20many\x20decoys\x20were\x20tried\x20before\x20success\n\n\r\n\x05\x04\
    \x07\x02\0\x04\x12\x04\xcc\x01\x04\x0c\n\r\n\x05\x04\x07\x02\0\x05\x12\
    \x04\xcc\x01\r\x13\n\r\n\x05\x04\x07\x02\0\x01\x12\x04\xcc\x01\x14(\n\r\
    \n\x05\x04\x07\x02\0\x03\x12\x04\xcc\x01+-\nm\n\x04\x04\x07\x02\x01\x12\
    \x04\xd1\x01\x04/\x1a\x1e\x20Applicable\x20to\x20whole\x20session:\n\"\
    \x1a\x20includes\x20failed\x20attempts\n2#\x20Timings\x20below\x20are\
    \x20in\x20milliseconds\n\n\r\n\x05\x04\x07\x02\x01\x04\x12\x04\xd1\x01\
    \x04\x0c\n\r\n\x05\x04\x07\x02\x01\x05\x12\x04\xd1\x01\r\x13\n\r\n\x05\
    \x04\x07\x02\x01\x01\x12\x04\xd1\x01\x14)\n\r\n\x05\x04\x07\x02\x01\x03\
    \x12\x04\xd1\x01,.\nR\n\x04\x04\x07\x02\x02\x12\x04\xd4\x01\x04(\x1a\x1f\
    \x20Last\x20(i.e.\x20successful)\x20decoy:\n\"#\x20measured\x20during\
    \x20initial\x20handshake\n\n\r\n\x05\x04\x07\x02\x02\x04\x12\x04\xd4\x01\
    \x04\x0c\n\r\n\x05\x04\x07\x02\x02\x05\x12\x04\xd4\x01\r\x13\n\r\n\x05\
    \x04\x07\x02\x02\x01\x12\x04\xd4\x01\x14\"\n\r\n\x05\x04\x07\x02\x02\x03\
    \x12\x04\xd4\x01%'\n%\n\x04\x04\x07\x02\x03\x12\x04\xd5\x01\x04&\"\x17\
    \x20includes\x20tcp\x20to\x20decoy\n\n\r\n\x05\x04\x07\x02\x03\x04\x12\
    \x04\xd5\x01\x04\x0c\n\r\n\x05\x04\x07\x02\x03\x05\x12\x04\xd5\x01\r\x13\
    \n\r\n\x05\x04\x07\x02\x03\x01\x12\x04\xd5\x01\x14\x20\n\r\n\x05\x04\x07\
    \x02\x03\x03\x12\x04\xd5\x01#%\nB\n\x04\x04\x07\x02\x04\x12\x04\xd6\x01\
    \x04&\"4\x20measured\x20when\x20establishing\x20tcp\x20connection\x20to\
    \x20decot\n\n\r\n\x05\x04\x07\x02\x04\x04\x12\x04\xd6\x01\x04\x0c\n\r\n\
    \x05\x04\x07\x02\x04\x05\x12\x04\xd6\x01\r\x13\n\r\n\x05\x04\x07\x02\x04\
    \x01\x12\x04\xd6\x01\x14\x20\n\r\n\x05\x04\x07\x02\x04\x03\x12\x04\xd6\
    \x01#%\
";
