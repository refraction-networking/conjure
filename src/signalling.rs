...
#[derive(PartialEq,Clone,Default,Debug)]
// @@protoc_insertion_point(message:tapdance.UTLSTransportParams)
pub struct UTLSTransportParams {
    // message fields
    // @@protoc_insertion_point(field:tapdance.UTLSTransportParams.ch_id)
    pub ch_id: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:tapdance.UTLSTransportParams.ch_spec)
    pub ch_spec: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:tapdance.UTLSTransportParams.ciphersuite)
    pub ciphersuite: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:tapdance.UTLSTransportParams.sni)
    pub sni: ::std::option::Option<::std::vec::Vec<u8>>,
    ...
    ///  supported.
    // @@protoc_insertion_point(field:tapdance.UTLSTransportParams.randomize_dst_port)
    pub randomize_dst_port: ::std::option::Option<bool>,
    // special fields
    // @@protoc_insertion_point(special_field:tapdance.UTLSTransportParams.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a UTLSTransportParams {
    fn default() -> &'a UTLSTransportParams {
        <UTLSTransportParams as ::protobuf::Message>::default_instance()
    }
}

impl UTLSTransportParams {
    pub fn new() -> UTLSTransportParams {
        ::std::default::Default::default()
    }

    // optional int32 ch_id = 1;

    pub fn ch_id(&self) -> i32 {
        self.ch_id.unwrap_or(0)
    }

    pub fn clear_ch_id(&mut self) {
        self.ch_id = ::std::option::Option::None;
    }

    pub fn has_ch_id(&self) -> bool {
        self.ch_id.is_some()
    }

    // Param is passed by value, moved
    pub fn set_ch_id(&mut self, v: i32) {
        self.ch_id = ::std::option::Option::Some(v);
    }

    // optional bytes ch_spec = 2;

    pub fn ch_spec(&self) -> &[u8] {
        match self.ch_spec.as_ref() {
            Some(v) => v,
            None => &[],
        }
    }

    pub fn clear_ch_spec(&mut self) {
        self.ch_spec = ::std::option::Option::None;
    }

    pub fn has_ch_spec(&self) -> bool {
        self.ch_spec.is_some()
    }

    // Param is passed by value, moved
    pub fn set_ch_spec(&mut self, v: ::std::vec::Vec<u8>) {
        self.ch_spec = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_ch_spec(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.ch_spec.is_none() {
            self.ch_spec = ::std::option::Option::Some(::std::vec::Vec::new());
        }
        self.ch_spec.as_mut().unwrap()
    }

    // Take field
    pub fn take_ch_spec(&mut self) -> ::std::vec::Vec<u8> {
        self.ch_spec.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }

    // optional int32 ciphersuite = 3;

    pub fn ciphersuite(&self) -> i32 {
        self.ciphersuite.unwrap_or(0)
    }

    pub fn clear_ciphersuite(&mut self) {
        self.ciphersuite = ::std::option::Option::None;
    }

    pub fn has_ciphersuite(&self) -> bool {
        self.ciphersuite.is_some()
    }

    // Param is passed by value, moved
    pub fn set_ciphersuite(&mut self, v: i32) {
        self.ciphersuite = ::std::option::Option::Some(v);
    }

    // optional bytes sni = 8;

    pub fn sni(&self) -> &[u8] {
        match self.sni.as_ref() {
            Some(v) => v,
            None => &[],
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_sni(&mut self, v: ::std::vec::Vec<u8>) {
        self.sni = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_sni(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.sni.is_none() {
            self.sni = ::std::option::Option::Some(::std::vec::Vec::new());
        }
        self.sni.as_mut().unwrap()
    }

    // Take field
    pub fn take_sni(&mut self) -> ::std::vec::Vec<u8> {
        self.sni.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "ch_id",
            |m: &UTLSTransportParams| { &m.ch_id },
            |m: &mut UTLSTransportParams| { &mut m.ch_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "ch_spec",
            |m: &UTLSTransportParams| { &m.ch_spec },
            |m: &mut UTLSTransportParams| { &mut m.ch_spec },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "ciphersuite",
            |m: &UTLSTransportParams| { &m.ciphersuite },
            |m: &mut UTLSTransportParams| { &mut m.ciphersuite },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "sni",
            |m: &UTLSTransportParams| { &m.sni },
            |m: &mut UTLSTransportParams| { &mut m.sni },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "randomize_dst_port",
            |m: &UTLSTransportParams| { &m.randomize_dst_port },
            |m: &mut UTLSTransportParams| { &mut m.randomize_dst_port },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<UTLSTransportParams>(
            "UTLSTransportParams",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for UTLSTransportParams {
    const NAME: &'static str = "UTLSTransportParams";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.ch_id = ::std::option::Option::Some(is.read_int32()?);
                },
                18 => {
                    self.ch_spec = ::std::option::Option::Some(is.read_bytes()?);
                },
                24 => {
                    self.ciphersuite = ::std::option::Option::Some(is.read_int32()?);
                },
                66 => {
                    self.sni = ::std::option::Option::Some(is.read_bytes()?);
                },
                104 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.ch_id {
            my_size += ::protobuf::rt::int32_size(1, v);
        }
        if let Some(v) = self.ch_spec.as_ref() {
            my_size += ::protobuf::rt::bytes_size(2, &v);
        }
        if let Some(v) = self.ciphersuite {
    ...
    fn new() -> UTLSTransportParams {
        UTLSTransportParams::new()
    }
    ...
    fn default_instance() -> &'static UTLSTransportParams {
        static instance: UTLSTransportParams = UTLSTransportParams {
            ch_id: ::std::option::Option::None,
            ch_spec: ::std::option::Option::None,
            ciphersuite: ::std::option::Option::None,
...
impl ::protobuf::MessageFull for UTLSTransportParams {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("UTLSTransportParams").unwrap()).clone()
    }
}

impl ::std::fmt::Display for UTLSTransportParams {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for UTLSTransportParams {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0cR\x07padding\"\xa5\x01\n\x13UTLSTransportParams\x12\x13\n\x05ch_id\
    \x18\x01\x20\x01(\x05R\x04chId\x12\x17\n\x07ch_spec\x18\x02\x20\x01(\x0c\
    R\x06chSpec\x12\x20\n\x0bciphersuite\x18\x03\x20\x01(\x05R\x0bciphersuit\
    e\x12\x10\n\x03sni\x18\x08\x20\x01(\x0cR\x03sni\x12,\n\x12randomize_dst_\
    port\x18\r\x20\x01(\x08R\x10randomizeDstPort\"\xa8\x01\n\x15PrefixTransp\
    ortParams\x12\x1b\n\tprefix_id\x18\x01\x20\x01(\x05R\x08prefixId\x12\x16\
    \n\x06prefix\x18\x02\x20\x01(\x0cR\x06prefix\x12,\n\x12flush_after_prefi\
    x\x18\x03\x20\x01(\x08R\x10flushAfterPrefix\x12,\n\x12randomize_dst_port\
    \x18\r\x20\x01(\x08R\x10randomizeDstPort\"F\n\x16GenericTransportParams\
    \x12,\n\x12randomize_dst_port\x18\r\x20\x01(\x08R\x10randomizeDstPort\"\
    \xcb\x03\n\nC2SWrapper\x12#\n\rshared_secret\x18\x01\x20\x01(\x0cR\x0csh\
    aredSecret\x12L\n\x14registration_payload\x18\x03\x20\x01(\x0b2\x19.tapd\
    ance.ClientToStationR\x13registrationPayload\x12M\n\x13registration_sour\
    ce\x18\x04\x20\x01(\x0e2\x1c.tapdance.RegistrationSourceR\x12registratio\
    nSource\x121\n\x14registration_address\x18\x06\x20\x01(\x0cR\x13registra\
    tionAddress\x12#\n\rdecoy_address\x18\x07\x20\x01(\x0cR\x0cdecoyAddress\
    \x12S\n\x15registration_response\x18\x08\x20\x01(\x0b2\x1e.tapdance.Regi\
    strationResponseR\x14registrationResponse\x12\"\n\x0cRegRespBytes\x18\t\
    \x20\x01(\x0cR\x0cRegRespBytes\x12*\n\x10RegRespSignature\x18\n\x20\x01(\
    \x0cR\x10RegRespSignature\"\xdd\x01\n\x0cSessionStats\x120\n\x14failed_d\
    ecoys_amount\x18\x14\x20\x01(\rR\x12failedDecoysAmount\x121\n\x15total_t\
    ime_to_connect\x18\x1f\x20\x01(\rR\x12totalTimeToConnect\x12$\n\x0ertt_t\
    o_station\x18!\x20\x01(\rR\x0crttToStation\x12\x20\n\x0ctls_to_decoy\x18\
    &\x20\x01(\rR\ntlsToDecoy\x12\x20\n\x0ctcp_to_decoy\x18'\x20\x01(\rR\ntc\
    pToDecoy\"\x88\x02\n\x11StationToDetector\x12\x1d\n\nphantom_ip\x18\x01\
    \x20\x01(\tR\tphantomIp\x12\x1b\n\tclient_ip\x18\x02\x20\x01(\tR\x08clie\
    ntIp\x12\x1d\n\ntimeout_ns\x18\x03\x20\x01(\x04R\ttimeoutNs\x129\n\toper\
    ation\x18\x04\x20\x01(\x0e2\x1b.tapdance.StationOperationsR\toperation\
    \x12\x19\n\x08dst_port\x18\n\x20\x01(\rR\x07dstPort\x12\x19\n\x08src_por\
    t\x18\x0b\x20\x01(\rR\x07srcPort\x12'\n\x05proto\x18\x0c\x20\x01(\x0e2\
    \x11.tapdance.IPProtoR\x05proto\"\x9a\x02\n\x14RegistrationResponse\x12\
    ...
    \x10transport_params\x18\n\x20\x01(\x0b2\x14.google.protobuf.AnyR\x0ftra\
    nsportParams\"\xaf\x01\n\x0bDnsResponse\x12\x18\n\x07success\x18\x01\x20\
    \x01(\x08R\x07success\x12/\n\x13clientconf_outdated\x18\x02\x20\x01(\x08\
    R\x12clientconfOutdated\x12U\n\x16bidirectional_response\x18\x03\x20\x01\
    (\x0b2\x1e.tapdance.RegistrationResponseR\x15bidirectionalResponse*+\n\
    ...
    egistrationSource\x12\x0f\n\x0bUnspecified\x10\0\x12\x0c\n\x08Detector\
    \x10\x01\x12\x07\n\x03API\x10\x02\x12\x13\n\x0fDetectorPrescan\x10\x03\
    ...
    \x10\x01\x12\x07\n\x03Udp\x10\x02J\xd7\x92\x01\n\x07\x12\x05\0\0\xb1\x03\
    \x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\xb0\x01\n\x01\x02\x12\x03\x06\0\
    \x112\xa5\x01\x20TODO:\x20We're\x20using\x20proto2\x20because\x20it's\
    ...
    \x02\x05\x04\x12\x03Y\x04\x0c\n\x0c\n\x05\x04\x02\x02\x05\x06\x12\x03Y\r\
    \x17\n\x0c\n\x05\x04\x02\x02\x05\x01\x12\x03Y\x18$\n\x0c\n\x05\x04\x02\
    \x02\x05\x03\x12\x03Y'(\n-\n\x02\x04\x03\x12\x04]\0d\x01\x1a!\x20Configu\
    ration\x20for\x20DNS\x20registrar\n\n\n\n\x03\x04\x03\x01\x12\x03]\x08\
    ...
    \x01\x12\x04\xa0\x01\x04\x0c\"R\x20Send\x20a\x2032-byte\x20HMAC\x20id\
    ...
    \x07\x12\x04\xa6\x01\x04\r\"\r\x20WebAssembly\n\n\r\n\x05\x05\x05\x02\
    \x07\x01\x12\x04\xa6\x01\x04\x08\n\r\n\x05\x05\x05\x02\x07\x02\x12\x04\
    \xa6\x01\x0b\x0c\n.\n\x04\x05\x05\x02\x08\x12\x04\xa7\x01\x04\x0c\"\x20\
    \x20Format\x20transforming\x20encryption\n\n\r\n\x05\x05\x05\x02\x08\x01\
    \x12\x04\xa7\x01\x04\x07\n\r\n\x05\x05\x05\x02\x08\x02\x12\x04\xa7\x01\n\
    \x0b\n\x1f\n\x04\x05\x05\x02\t\x12\x04\xa8\x01\x04\r\"\x11\x20quic\x20tr\
    ansport?\n\n\r\n\x05\x05\x05\x02\t\x01\x12\x04\xa8\x01\x04\x08\n\r\n\x05\
    \x05\x05\x02\t\x02\x12\x04\xa8\x01\x0b\x0c\n1\n\x04\x05\x05\x02\n\x12\
    \x04\xa9\x01\x04\x10\"#\x20UDP\x20transport:\x20WebRTC\x20DataChannel\n\
    \n\r\n\x05\x05\x05\x02\n\x01\x12\x04\xa9\x01\x04\n\n\r\n\x05\x05\x05\x02\
    \n\x02\x12\x04\xa9\x01\r\x0f\n:\n\x02\x04\x07\x12\x06\xad\x01\0\xb3\x01\
    \x01\x1a,\x20Deflated\x20ICE\x20Candidate\x20by\x20seed2sdp\x20package\n\
    \n\x0b\n\x03\x04\x07\x01\x12\x04\xad\x01\x08\x1a\n5\n\x04\x04\x07\x02\0\
    \x12\x04\xaf\x01\x04!\x1a'\x20IP\x20is\x20represented\x20in\x20its\x2016\
    -byte\x20form\n\n\r\n\x05\x04\x07\x02\0\x04\x12\x04\xaf\x01\x04\x0c\n\r\
    \n\x05\x04\x07\x02\0\x05\x12\x04\xaf\x01\r\x13\n\r\n\x05\x04\x07\x02\0\
    \x01\x12\x04\xaf\x01\x14\x1c\n\r\n\x05\x04\x07\x02\0\x03\x12\x04\xaf\x01\
    \x1f\x20\n\x0c\n\x04\x04\x07\x02\x01\x12\x04\xb0\x01\x04!\n\r\n\x05\x04\
    \x07\x02\x01\x04\x12\x04\xb0\x01\x04\x0c\n\r\n\x05\x04\x07\x02\x01\x05\
    \x12\x04\xb0\x01\r\x13\n\r\n\x05\x04\x07\x02\x01\x01\x12\x04\xb0\x01\x14\
    \x1c\n\r\n\x05\x04\x07\x02\x01\x03\x12\x04\xb0\x01\x1f\x20\n\x9b\x01\n\
    \x04\x04\x07\x02\x02\x12\x04\xb2\x01\x04&\x1a\x8c\x01\x20Composed\x20inf\
    ...
    \x04\x08\x02\x01\x04\x12\x04\xb8\x01\x04\x0c\n\r\n\x05\x04\x08\x02\x01\
    \x06\x12\x04\xb8\x01\r\x1f\n\r\n\x05\x04\x08\x02\x01\x01\x12\x04\xb8\x01\
    \x20*\n\r\n\x05\x04\x08\x02\x01\x03\x12\x04\xb8\x01-.\n?\n\x02\x04\t\x12\
    \x06\xbc\x01\0\xbf\x01\x01\x1a1\x20WebRTCSignal\x20includes\x20a\x20defl\
    ated\x20SDP\x20and\x20a\x20seed\n\n\x0b\n\x03\x04\t\x01\x12\x04\xbc\x01\
    ...
    \x04\t\x02\0\x03\x12\x04\xbd\x01\x1b\x1c\n\x0c\n\x04\x04\t\x02\x01\x12\
    \x04\xbe\x01\x04\x1f\n\r\n\x05\x04\t\x02\x01\x04\x12\x04\xbe\x01\x04\x0c\
    \n\r\n\x05\x04\t\x02\x01\x06\x12\x04\xbe\x01\r\x16\n\r\n\x05\x04\t\x02\
    \x01\x01\x12\x04\xbe\x01\x17\x1a\n\r\n\x05\x04\t\x02\x01\x03\x12\x04\xbe\
    \x01\x1d\x1e\n\x0c\n\x02\x04\n\x12\x06\xc1\x01\0\xd8\x01\x01\n\x0b\n\x03\
    \x04\n\x01\x12\x04\xc1\x01\x08\x17\nO\n\x04\x04\n\x02\0\x12\x04\xc3\x01\
    \x04)\x1aA\x20Should\x20accompany\x20(at\x20least)\x20SESSION_INIT\x20an\
    d\x20CONFIRM_RECONNECT.\n\n\r\n\x05\x04\n\x02\0\x04\x12\x04\xc3\x01\x04\
    \x0c\n\r\n\x05\x04\n\x02\0\x05\x12\x04\xc3\x01\r\x13\n\r\n\x05\x04\n\x02\
    \0\x01\x12\x04\xc3\x01\x14$\n\r\n\x05\x04\n\x02\0\x03\x12\x04\xc3\x01'(\
    \nv\n\x04\x04\n\x02\x01\x12\x04\xc7\x01\x041\x1ah\x20There\x20might\x20b\
    e\x20a\x20state\x20transition.\x20May\x20be\x20absent;\x20absence\x20sho\
    uld\x20be\n\x20treated\x20identically\x20to\x20NO_CHANGE.\n\n\r\n\x05\
    \x04\n\x02\x01\x04\x12\x04\xc7\x01\x04\x0c\n\r\n\x05\x04\n\x02\x01\x06\
    \x12\x04\xc7\x01\r\x1b\n\r\n\x05\x04\n\x02\x01\x01\x12\x04\xc7\x01\x1c,\
    \n\r\n\x05\x04\n\x02\x01\x03\x12\x04\xc7\x01/0\nc\n\x04\x04\n\x02\x02\
    \x12\x04\xcb\x01\x04(\x1aU\x20The\x20station\x20can\x20send\x20client\
    \x20config\x20info\x20piggybacked\n\x20on\x20any\x20message,\x20as\x20it\
    \x20sees\x20fit\n\n\r\n\x05\x04\n\x02\x02\x04\x12\x04\xcb\x01\x04\x0c\n\
    \r\n\x05\x04\n\x02\x02\x06\x12\x04\xcb\x01\r\x17\n\r\n\x05\x04\n\x02\x02\
    \x01\x12\x04\xcb\x01\x18#\n\r\n\x05\x04\n\x02\x02\x03\x12\x04\xcb\x01&'\
    \nP\n\x04\x04\n\x02\x03\x12\x04\xce\x01\x04+\x1aB\x20If\x20state_transit\
    ion\x20==\x20S2C_ERROR,\x20this\x20field\x20is\x20the\x20explanation.\n\
    \n\r\n\x05\x04\n\x02\x03\x04\x12\x04\xce\x01\x04\x0c\n\r\n\x05\x04\n\x02\
    \x03\x06\x12\x04\xce\x01\r\x1b\n\r\n\x05\x04\n\x02\x03\x01\x12\x04\xce\
    \x01\x1c&\n\r\n\x05\x04\n\x02\x03\x03\x12\x04\xce\x01)*\nQ\n\x04\x04\n\
    \x02\x04\x12\x04\xd1\x01\x04$\x1aC\x20Signals\x20client\x20to\x20stop\
    \x20connecting\x20for\x20following\x20amount\x20of\x20seconds\n\n\r\n\
    \x05\x04\n\x02\x04\x04\x12\x04\xd1\x01\x04\x0c\n\r\n\x05\x04\n\x02\x04\
    \x05\x12\x04\xd1\x01\r\x13\n\r\n\x05\x04\n\x02\x04\x01\x12\x04\xd1\x01\
    \x14\x1f\n\r\n\x05\x04\n\x02\x04\x03\x12\x04\xd1\x01\"#\nK\n\x04\x04\n\
    \x02\x05\x12\x04\xd4\x01\x04#\x1a=\x20Sent\x20in\x20SESSION_INIT,\x20ide\
    ntifies\x20the\x20station\x20that\x20picked\x20up\n\n\r\n\x05\x04\n\x02\
    \x05\x04\x12\x04\xd4\x01\x04\x0c\n\r\n\x05\x04\n\x02\x05\x05\x12\x04\xd4\
    \x01\r\x13\n\r\n\x05\x04\n\x02\x05\x01\x12\x04\xd4\x01\x14\x1e\n\r\n\x05\
    \x04\n\x02\x05\x03\x12\x04\xd4\x01!\"\nG\n\x04\x04\n\x02\x06\x12\x04\xd7\
    \x01\x04!\x1a9\x20Random-sized\x20junk\x20to\x20defeat\x20packet\x20size\
    \x20fingerprinting.\n\n\r\n\x05\x04\n\x02\x06\x04\x12\x04\xd7\x01\x04\
    ...
    r\x20is\x20happening.\n\n\r\n\x05\x04\x0c\x02\x03\x04\x12\x04\xee\x01\
    \x04\x0c\n\r\n\x05\x04\x0c\x02\x03\x05\x12\x04\xee\x01\r\x13\n\r\n\x05\
    \x04\x0c\x02\x03\x01\x12\x04\xee\x01\x14\x1f\n\r\n\x05\x04\x0c\x02\x03\
    \x03\x12\x04\xee\x01\"#\ng\n\x04\x04\x0c\x02\x04\x12\x04\xf2\x01\x04+\
    \x1aY\x20High\x20level\x20client\x20library\x20version\x20used\x20for\
    \x20indicating\x20feature\x20support,\x20or\n\x20lack\x20therof.\n\n\r\n\
    \x05\x04\x0c\x02\x04\x04\x12\x04\xf2\x01\x04\x0c\n\r\n\x05\x04\x0c\x02\
    \x04\x05\x12\x04\xf2\x01\r\x13\n\r\n\x05\x04\x0c\x02\x04\x01\x12\x04\xf2\
    \x01\x14&\n\r\n\x05\x04\x0c\x02\x04\x03\x12\x04\xf2\x01)*\n\xa5\x02\n\
    \x04\x04\x0c\x02\x05\x12\x04\xf7\x01\x042\x1a\x96\x02\x20Indicates\x20wh\
    ether\x20the\x20client\x20will\x20allow\x20the\x20registrar\x20to\x20pro\
    vide\x20alternative\x20parameters\x20that\n\x20may\x20work\x20better\x20\
    in\x20substitute\x20for\x20the\x20deterministically\x20selected\x20param\
    eters.\x20This\x20only\x20works\n\x20for\x20bidirectional\x20registratio\
    n\x20methods\x20where\x20the\x20client\x20receives\x20a\x20RegistrationR\
    esponse.\n\n\r\n\x05\x04\x0c\x02\x05\x04\x12\x04\xf7\x01\x04\x0c\n\r\n\
    \x05\x04\x0c\x02\x05\x05\x12\x04\xf7\x01\r\x11\n\r\n\x05\x04\x0c\x02\x05\
    \x01\x12\x04\xf7\x01\x12-\n\r\n\x05\x04\x0c\x02\x05\x03\x12\x04\xf7\x010\
    1\nq\n\x04\x04\x0c\x02\x06\x12\x04\xfb\x01\x04'\x1ac\x20List\x20of\x20de\
    coys\x20that\x20client\x20have\x20unsuccessfully\x20tried\x20in\x20curre\
    nt\x20session.\n\x20Could\x20be\x20sent\x20in\x20chunks\n\n\r\n\x05\x04\
    \x0c\x02\x06\x04\x12\x04\xfb\x01\x04\x0c\n\r\n\x05\x04\x0c\x02\x06\x05\
    \x12\x04\xfb\x01\r\x13\n\r\n\x05\x04\x0c\x02\x06\x01\x12\x04\xfb\x01\x14\
    !\n\r\n\x05\x04\x0c\x02\x06\x03\x12\x04\xfb\x01$&\n\x0c\n\x04\x04\x0c\
    \x02\x07\x12\x04\xfd\x01\x04%\n\r\n\x05\x04\x0c\x02\x07\x04\x12\x04\xfd\
    \x01\x04\x0c\n\r\n\x05\x04\x0c\x02\x07\x06\x12\x04\xfd\x01\r\x19\n\r\n\
    \x05\x04\x0c\x02\x07\x01\x12\x04\xfd\x01\x1a\x1f\n\r\n\x05\x04\x0c\x02\
    \x07\x03\x12\x04\xfd\x01\"$\nk\n\x04\x04\x0c\x02\x08\x12\x04\x80\x02\x04\
    *\x1a]\x20NullTransport,\x20MinTransport,\x20Obfs4Transport,\x20etc.\x20\
    Transport\x20type\x20we\x20want\x20from\x20phantom\x20proxy\n\n\r\n\x05\
    \x04\x0c\x02\x08\x04\x12\x04\x80\x02\x04\x0c\n\r\n\x05\x04\x0c\x02\x08\
    \x06\x12\x04\x80\x02\r\x1a\n\r\n\x05\x04\x0c\x02\x08\x01\x12\x04\x80\x02\
    \x1b$\n\r\n\x05\x04\x0c\x02\x08\x03\x12\x04\x80\x02')\n\x0c\n\x04\x04\
    \x0c\x02\t\x12\x04\x82\x02\x047\n\r\n\x05\x04\x0c\x02\t\x04\x12\x04\x82\
    \x02\x04\x0c\n\r\n\x05\x04\x0c\x02\t\x06\x12\x04\x82\x02\r\x20\n\r\n\x05\
    \x04\x0c\x02\t\x01\x12\x04\x82\x02!1\n\r\n\x05\x04\x0c\x02\t\x03\x12\x04\
    \x82\x0246\n\xc8\x03\n\x04\x04\x0c\x02\n\x12\x04\x8a\x02\x04(\x1a\xb9\
    \x03\x20Station\x20is\x20only\x20required\x20to\x20check\x20this\x20vari\
    able\x20during\x20session\x20initialization.\n\x20If\x20set,\x20station\
    \x20must\x20facilitate\x20connection\x20to\x20said\x20target\x20by\x20it\
    self,\x20i.e.\x20write\x20into\x20squid\n\x20socket\x20an\x20HTTP/SOCKS/\
    any\x20other\x20connection\x20request.\n\x20covert_address\x20must\x20ha\
    ve\x20exactly\x20one\x20':'\x20colon,\x20that\x20separates\x20host\x20(l\
    iteral\x20IP\x20address\x20or\n\x20resolvable\x20hostname)\x20and\x20por\
    ...
    \x14\"\n\r\n\x05\x04\x0c\x02\n\x03\x12\x04\x8a\x02%'\nR\n\x04\x04\x0c\
    \x02\x0b\x12\x04\x8d\x02\x042\x1aD\x20Used\x20in\x20dark\x20decoys\x20to\
    \x20signal\x20which\x20dark\x20decoy\x20it\x20will\x20connect\x20to.\n\n\
    \r\n\x05\x04\x0c\x02\x0b\x04\x12\x04\x8d\x02\x04\x0c\n\r\n\x05\x04\x0c\
    \x02\x0b\x05\x12\x04\x8d\x02\r\x13\n\r\n\x05\x04\x0c\x02\x0b\x01\x12\x04\
    \x8d\x02\x14,\n\r\n\x05\x04\x0c\x02\x0b\x03\x12\x04\x8d\x02/1\nR\n\x04\
    \x04\x0c\x02\x0c\x12\x04\x90\x02\x04\"\x1aD\x20Used\x20to\x20indicate\
    \x20to\x20server\x20if\x20client\x20is\x20registering\x20v4,\x20v6\x20or\
    \x20both\n\n\r\n\x05\x04\x0c\x02\x0c\x04\x12\x04\x90\x02\x04\x0c\n\r\n\
    \x05\x04\x0c\x02\x0c\x05\x12\x04\x90\x02\r\x11\n\r\n\x05\x04\x0c\x02\x0c\
    \x01\x12\x04\x90\x02\x12\x1c\n\r\n\x05\x04\x0c\x02\x0c\x03\x12\x04\x90\
    \x02\x1f!\n\x0c\n\x04\x04\x0c\x02\r\x12\x04\x91\x02\x04\"\n\r\n\x05\x04\
    \x0c\x02\r\x04\x12\x04\x91\x02\x04\x0c\n\r\n\x05\x04\x0c\x02\r\x05\x12\
    \x04\x91\x02\r\x11\n\r\n\x05\x04\x0c\x02\r\x01\x12\x04\x91\x02\x12\x1c\n\
    \r\n\x05\x04\x0c\x02\r\x03\x12\x04\x91\x02\x1f!\nD\n\x04\x04\x0c\x02\x0e\
    \x12\x04\x94\x02\x04*\x1a6\x20A\x20collection\x20of\x20optional\x20flags\
    \x20for\x20the\x20registration.\n\n\r\n\x05\x04\x0c\x02\x0e\x04\x12\x04\
    \x94\x02\x04\x0c\n\r\n\x05\x04\x0c\x02\x0e\x06\x12\x04\x94\x02\r\x1e\n\r\
    \n\x05\x04\x0c\x02\x0e\x01\x12\x04\x94\x02\x1f$\n\r\n\x05\x04\x0c\x02\
    \x01\x12\x04\xa6\x02\x13\x16\n\r\n\x05\x04\r\x02\x03\x03\x12\x04\xa6\x02\
    \x19\x1a\n\xcb\x01\n\x04\x04\r\x02\x04\x12\x04\xab\x02\x04*\x1a\xbc\x01\
    ...
    \x04\x04\x12\x04\xab\x02\x04\x0c\n\r\n\x05\x04\r\x02\x04\x05\x12\x04\xab\
    \x02\r\x11\n\r\n\x05\x04\r\x02\x04\x01\x12\x04\xab\x02\x12$\n\r\n\x05\
    \x04\r\x02\x04\x03\x12\x04\xab\x02')\n\x0c\n\x02\x04\x0e\x12\x06\xae\x02\
    \0\xc0\x02\x01\n\x0b\n\x03\x04\x0e\x01\x12\x04\xae\x02\x08\x1d\n!\n\x04\
    \x04\x0e\x02\0\x12\x04\xb0\x02\x04!\x1a\x13\x20Prefix\x20Identifier\n\n\
    \r\n\x05\x04\x0e\x02\0\x04\x12\x04\xb0\x02\x04\x0c\n\r\n\x05\x04\x0e\x02\
    \0\x05\x12\x04\xb0\x02\r\x12\n\r\n\x05\x04\x0e\x02\0\x01\x12\x04\xb0\x02\
    \x13\x1c\n\r\n\x05\x04\x0e\x02\0\x03\x12\x04\xb0\x02\x1f\x20\n\xc4\x01\n\
    \x04\x04\x0e\x02\x01\x12\x04\xb4\x02\x04\x1e\x1a\xb5\x01\x20Prefix\x20by\
    tes\x20(optional\x20-\x20usually\x20sent\x20from\x20station\x20to\x20cli\
    ent\x20as\x20override\x20if\x20allowed\x20by\x20C2S)\n\x20as\x20the\x20s\
    tation\x20cannot\x20take\x20this\x20into\x20account\x20when\x20attemptin\
    g\x20to\x20identify\x20a\x20connection.\n\n\r\n\x05\x04\x0e\x02\x01\x04\
    \x12\x04\xb4\x02\x04\x0c\n\r\n\x05\x04\x0e\x02\x01\x05\x12\x04\xb4\x02\r\
    \x12\n\r\n\x05\x04\x0e\x02\x01\x01\x12\x04\xb4\x02\x13\x19\n\r\n\x05\x04\
    \x0e\x02\x01\x03\x12\x04\xb4\x02\x1c\x1d\n\x0c\n\x04\x04\x0e\x02\x02\x12\
    \x04\xb5\x02\x04)\n\r\n\x05\x04\x0e\x02\x02\x04\x12\x04\xb5\x02\x04\x0c\
    \n\r\n\x05\x04\x0e\x02\x02\x05\x12\x04\xb5\x02\r\x11\n\r\n\x05\x04\x0e\
    \x02\x02\x01\x12\x04\xb5\x02\x12$\n\r\n\x05\x04\x0e\x02\x02\x03\x12\x04\
    \xb5\x02'(\n\xed\x02\n\x04\x04\x0e\x02\x03\x12\x04\xbf\x02\x04*\x1a\xbc\
    \x01\x20Indicates\x20whether\x20the\x20client\x20has\x20elected\x20to\
    \x20use\x20destination\x20port\x20randomization.\x20Should\x20be\n\x20ch\
    ecked\x20against\x20selected\x20transport\x20to\x20ensure\x20that\x20des\
    tination\x20port\x20randomization\x20is\n\x20supported.\n2\x9f\x01\x20//\
    \x20potential\x20future\x20fields\n\x20obfuscator\x20ID\n\x20tagEncoder\
    \x20ID\x20(&params?,\x20e.g.\x20format-base64\x20/\x20padding)\n\x20stre\
    amEncoder\x20ID\x20(&params?,\x20e.g.\x20foramat-base64\x20/\x20padding)\
    \n\n\r\n\x05\x04\x0e\x02\x03\x04\x12\x04\xbf\x02\x04\x0c\n\r\n\x05\x04\
    \x0e\x02\x03\x05\x12\x04\xbf\x02\r\x11\n\r\n\x05\x04\x0e\x02\x03\x01\x12\
    \x04\xbf\x02\x12$\n\r\n\x05\x04\x0e\x02\x03\x03\x12\x04\xbf\x02')\n\x0c\
    \n\x02\x04\x0f\x12\x06\xc2\x02\0\xc7\x02\x01\n\x0b\n\x03\x04\x0f\x01\x12\
    \x04\xc2\x02\x08\x1e\n\xcb\x01\n\x04\x04\x0f\x02\0\x12\x04\xc6\x02\x04*\
    \x1a\xbc\x01\x20Indicates\x20whether\x20the\x20client\x20has\x20elected\
    \x20to\x20use\x20destination\x20port\x20randomization.\x20Should\x20be\n\
    \x20checked\x20against\x20selected\x20transport\x20to\x20ensure\x20that\
    \x20destination\x20port\x20randomization\x20is\n\x20supported.\n\n\r\n\
    \x05\x04\x0f\x02\0\x04\x12\x04\xc6\x02\x04\x0c\n\r\n\x05\x04\x0f\x02\0\
    \x05\x12\x04\xc6\x02\r\x11\n\r\n\x05\x04\x0f\x02\0\x01\x12\x04\xc6\x02\
    \x12$\n\r\n\x05\x04\x0f\x02\0\x03\x12\x04\xc6\x02')\n\x0c\n\x02\x05\x06\
    \x12\x06\xc9\x02\0\xd1\x02\x01\n\x0b\n\x03\x05\x06\x01\x12\x04\xc9\x02\
    \x05\x17\n\x0c\n\x04\x05\x06\x02\0\x12\x04\xca\x02\x02\x12\n\r\n\x05\x05\
    \x06\x02\0\x01\x12\x04\xca\x02\x02\r\n\r\n\x05\x05\x06\x02\0\x02\x12\x04\
    \xca\x02\x10\x11\n\x0c\n\x04\x05\x06\x02\x01\x12\x04\xcb\x02\x08\x15\n\r\
    \n\x05\x05\x06\x02\x01\x01\x12\x04\xcb\x02\x08\x10\n\r\n\x05\x05\x06\x02\
    \x01\x02\x12\x04\xcb\x02\x13\x14\n\x0c\n\x04\x05\x06\x02\x02\x12\x04\xcc\
    \x02\x08\x10\n\r\n\x05\x05\x06\x02\x02\x01\x12\x04\xcc\x02\x08\x0b\n\r\n\
    \x05\x05\x06\x02\x02\x02\x12\x04\xcc\x02\x0e\x0f\n\x0c\n\x04\x05\x06\x02\
    \x03\x12\x04\xcd\x02\x02\x16\n\r\n\x05\x05\x06\x02\x03\x01\x12\x04\xcd\
    \x02\x02\x11\n\r\n\x05\x05\x06\x02\x03\x02\x12\x04\xcd\x02\x14\x15\n\x0c\
    \n\x04\x05\x06\x02\x04\x12\x04\xce\x02\x02\x17\n\r\n\x05\x05\x06\x02\x04\
    \x01\x12\x04\xce\x02\x02\x12\n\r\n\x05\x05\x06\x02\x04\x02\x12\x04\xce\
    \x03\x12\x04\xdc\x02!\"\n\xeb\x05\n\x04\x04\x10\x02\x05\x12\x04\xe8\x02\
    ...
    \x04\x12\x04\xe8\x02\x02\n\n\r\n\x05\x04\x10\x02\x05\x06\x12\x04\xe8\x02\
    \x0b\x1f\n\r\n\x05\x04\x10\x02\x05\x01\x12\x04\xe8\x02\x205\n\r\n\x05\
    \x04\x10\x02\x05\x03\x12\x04\xe8\x0289\n\x0c\n\x04\x04\x10\x02\x06\x12\
    \x04\xe9\x02\x02\"\n\r\n\x05\x04\x10\x02\x06\x04\x12\x04\xe9\x02\x02\n\n\
    \r\n\x05\x04\x10\x02\x06\x05\x12\x04\xe9\x02\x0b\x10\n\r\n\x05\x04\x10\
    \x02\x06\x01\x12\x04\xe9\x02\x11\x1d\n\r\n\x05\x04\x10\x02\x06\x03\x12\
    \x04\xe9\x02\x20!\n\x0c\n\x04\x04\x10\x02\x07\x12\x04\xea\x02\x02'\n\r\n\
    \x05\x04\x10\x02\x07\x04\x12\x04\xea\x02\x02\n\n\r\n\x05\x04\x10\x02\x07\
    \x05\x12\x04\xea\x02\x0b\x10\n\r\n\x05\x04\x10\x02\x07\x01\x12\x04\xea\
    \x02\x11!\n\r\n\x05\x04\x10\x02\x07\x03\x12\x04\xea\x02$&\n\x0c\n\x02\
    \x04\x11\x12\x06\xed\x02\0\xf9\x02\x01\n\x0b\n\x03\x04\x11\x01\x12\x04\
    \xed\x02\x08\x14\n9\n\x04\x04\x11\x02\0\x12\x04\xee\x02\x04.\"+\x20how\
    \x20many\x20decoys\x20were\x20tried\x20before\x20success\n\n\r\n\x05\x04\
    \x11\x02\0\x04\x12\x04\xee\x02\x04\x0c\n\r\n\x05\x04\x11\x02\0\x05\x12\
    \x04\xee\x02\r\x13\n\r\n\x05\x04\x11\x02\0\x01\x12\x04\xee\x02\x14(\n\r\
    \n\x05\x04\x11\x02\0\x03\x12\x04\xee\x02+-\nm\n\x04\x04\x11\x02\x01\x12\
    \x04\xf3\x02\x04/\x1a\x1e\x20Applicable\x20to\x20whole\x20session:\n\"\
    \x1a\x20includes\x20failed\x20attempts\n2#\x20Timings\x20below\x20are\
    \x20in\x20milliseconds\n\n\r\n\x05\x04\x11\x02\x01\x04\x12\x04\xf3\x02\
    \x04\x0c\n\r\n\x05\x04\x11\x02\x01\x05\x12\x04\xf3\x02\r\x13\n\r\n\x05\
    \x04\x11\x02\x01\x01\x12\x04\xf3\x02\x14)\n\r\n\x05\x04\x11\x02\x01\x03\
    \x12\x04\xf3\x02,.\nR\n\x04\x04\x11\x02\x02\x12\x04\xf6\x02\x04(\x1a\x1f\
    \x20Last\x20(i.e.\x20successful)\x20decoy:\n\"#\x20measured\x20during\
    \x20initial\x20handshake\n\n\r\n\x05\x04\x11\x02\x02\x04\x12\x04\xf6\x02\
    \x04\x0c\n\r\n\x05\x04\x11\x02\x02\x05\x12\x04\xf6\x02\r\x13\n\r\n\x05\
    \x05\x04\x12\x02\x05\x01\x12\x04\x91\x03\x14\x1c\n\r\n\x05\x04\x12\x02\
    \x05\x03\x12\x04\x91\x03\x1f!\n\x0c\n\x04\x04\x12\x02\x06\x12\x04\x92\
    \x03\x04\x20\n\r\n\x05\x04\x12\x02\x06\x04\x12\x04\x92\x03\x04\x0c\n\r\n\
    \x05\x04\x12\x02\x06\x06\x12\x04\x92\x03\r\x14\n\r\n\x05\x04\x12\x02\x06\
    \x01\x12\x04\x92\x03\x15\x1a\n\r\n\x05\x04\x12\x02\x06\x03\x12\x04\x92\
    \x03\x1d\x1f\nT\n\x02\x04\x13\x12\x06\x96\x03\0\xaa\x03\x01\x1aF\x20Addi\
    ng\x20message\x20response\x20from\x20Station\x20to\x20Client\x20for\x20b\
    idirectional\x20API\n\n\x0b\n\x03\x04\x13\x01\x12\x04\x96\x03\x08\x1c\n\
    \x0c\n\x04\x04\x13\x02\0\x12\x04\x97\x03\x02\x20\n\r\n\x05\x04\x13\x02\0\
    \x04\x12\x04\x97\x03\x02\n\n\r\n\x05\x04\x13\x02\0\x05\x12\x04\x97\x03\
    \x0b\x12\n\r\n\x05\x04\x13\x02\0\x01\x12\x04\x97\x03\x13\x1b\n\r\n\x05\
    \x04\x13\x02\0\x03\x12\x04\x97\x03\x1e\x1f\n?\n\x04\x04\x13\x02\x01\x12\
    \x04\x99\x03\x02\x1e\x1a1\x20The\x20128-bit\x20ipv6\x20address,\x20in\
    \x20network\x20byte\x20order\n\n\r\n\x05\x04\x13\x02\x01\x04\x12\x04\x99\
    \x03\x02\n\n\r\n\x05\x04\x13\x02\x01\x05\x12\x04\x99\x03\x0b\x10\n\r\n\
    \x05\x04\x13\x02\x01\x01\x12\x04\x99\x03\x11\x19\n\r\n\x05\x04\x13\x02\
    \x01\x03\x12\x04\x99\x03\x1c\x1d\n,\n\x04\x04\x13\x02\x02\x12\x04\x9c\
    \x03\x02\x1f\x1a\x1e\x20Respond\x20with\x20randomized\x20port\n\n\r\n\
    \x05\x04\x13\x02\x02\x04\x12\x04\x9c\x03\x02\n\n\r\n\x05\x04\x13\x02\x02\
    \x05\x12\x04\x9c\x03\x0b\x11\n\r\n\x05\x04\x13\x02\x02\x01\x12\x04\x9c\
    \x03\x12\x1a\n\r\n\x05\x04\x13\x02\x02\x03\x12\x04\x9c\x03\x1d\x1e\nd\n\
    \x04\x04\x13\x02\x03\x12\x04\xa0\x03\x02\"\x1aV\x20Future:\x20station\
    ...
    \xa0\x03\x02\n\n\r\n\x05\x04\x13\x02\x03\x05\x12\x04\xa0\x03\x0b\x10\n\r\
    \n\x05\x04\x13\x02\x03\x01\x12\x04\xa0\x03\x11\x1d\n\r\n\x05\x04\x13\x02\
    \x03\x03\x12\x04\xa0\x03\x20!\nA\n\x04\x04\x13\x02\x04\x12\x04\xa3\x03\
    \x02\x1c\x1a3\x20If\x20registration\x20wrong,\x20populate\x20this\x20err\
    or\x20string\n\n\r\n\x05\x04\x13\x02\x04\x04\x12\x04\xa3\x03\x02\n\n\r\n\
    \x05\x04\x13\x02\x04\x05\x12\x04\xa3\x03\x0b\x11\n\r\n\x05\x04\x13\x02\
    \x04\x01\x12\x04\xa3\x03\x12\x17\n\r\n\x05\x04\x13\x02\x04\x03\x12\x04\
    \xa3\x03\x1a\x1b\n+\n\x04\x04\x13\x02\x05\x12\x04\xa6\x03\x02%\x1a\x1d\
    \x20ClientConf\x20field\x20(optional)\n\n\r\n\x05\x04\x13\x02\x05\x04\
    \x12\x04\xa6\x03\x02\n\n\r\n\x05\x04\x13\x02\x05\x06\x12\x04\xa6\x03\x0b\
    \x15\n\r\n\x05\x04\x13\x02\x05\x01\x12\x04\xa6\x03\x16\x20\n\r\n\x05\x04\
    \x13\x02\x05\x03\x12\x04\xa6\x03#$\nJ\n\x04\x04\x13\x02\x06\x12\x04\xa9\
    \x03\x025\x1a<\x20Transport\x20Params\x20to\x20if\x20`allow_registrar_ov\
    errides`\x20is\x20set.\n\n\r\n\x05\x04\x13\x02\x06\x04\x12\x04\xa9\x03\
    \x02\n\n\r\n\x05\x04\x13\x02\x06\x06\x12\x04\xa9\x03\x0b\x1e\n\r\n\x05\
    \x04\x13\x02\x06\x01\x12\x04\xa9\x03\x1f/\n\r\n\x05\x04\x13\x02\x06\x03\
    \x12\x04\xa9\x0324\n!\n\x02\x04\x14\x12\x06\xad\x03\0\xb1\x03\x01\x1a\
    \x13\x20response\x20from\x20dns\n\n\x0b\n\x03\x04\x14\x01\x12\x04\xad\
    \x03\x08\x13\n\x0c\n\x04\x04\x14\x02\0\x12\x04\xae\x03\x04\x1e\n\r\n\x05\
    \x04\x14\x02\0\x04\x12\x04\xae\x03\x04\x0c\n\r\n\x05\x04\x14\x02\0\x05\
    \x12\x04\xae\x03\r\x11\n\r\n\x05\x04\x14\x02\0\x01\x12\x04\xae\x03\x12\
    \x19\n\r\n\x05\x04\x14\x02\0\x03\x12\x04\xae\x03\x1c\x1d\n\x0c\n\x04\x04\
    \x14\x02\x01\x12\x04\xaf\x03\x04*\n\r\n\x05\x04\x14\x02\x01\x04\x12\x04\
    \xaf\x03\x04\x0c\n\r\n\x05\x04\x14\x02\x01\x05\x12\x04\xaf\x03\r\x11\n\r\
    \n\x05\x04\x14\x02\x01\x01\x12\x04\xaf\x03\x12%\n\r\n\x05\x04\x14\x02\
    \x01\x03\x12\x04\xaf\x03()\n\x0c\n\x04\x04\x14\x02\x02\x12\x04\xb0\x03\
    \x04=\n\r\n\x05\x04\x14\x02\x02\x04\x12\x04\xb0\x03\x04\x0c\n\r\n\x05\
    \x04\x14\x02\x02\x06\x12\x04\xb0\x03\r!\n\r\n\x05\x04\x14\x02\x02\x01\
    \x12\x04\xb0\x03\"8\n\r\n\x05\x04\x14\x02\x02\x03\x12\x04\xb0\x03;<\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(UTLSTransportParams::generated_message_descriptor_data());
