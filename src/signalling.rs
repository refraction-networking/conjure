...
impl ClientToStation {
    ...
    pub fn get_transport(&self) -> TransportType {
        self.transport.unwrap_or(TransportType::NullTransport)
    }
...
impl<'a> ::std::default::Default for &'a ClientToAPI {
    fn default() -> &'a ClientToAPI {
        <ClientToAPI as ::protobuf::Message>::default_instance()
    }
}

impl ClientToAPI {
    pub fn new() -> ClientToAPI {
        ::std::default::Default::default()
    }
    ...
    // optional .tapdance.ClientToStation registration_payload = 2;
...
impl ::protobuf::Message for ClientToAPI {
    fn is_initialized(&self) -> bool {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                "secret",
                |m: &ClientToAPI| { &m.secret },
                |m: &mut ClientToAPI| { &mut m.secret },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<ClientToStation>>(
                ...
                |m: &ClientToAPI| { &m.registration_payload },
                |m: &mut ClientToAPI| { &mut m.registration_payload },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<ClientToAPI>(
                "ClientToAPI",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static ClientToAPI {
        static instance: ::protobuf::rt::LazyV2<ClientToAPI> = ::protobuf::rt::LazyV2::INIT;
        instance.get(ClientToAPI::new)
    }
}

impl ::protobuf::Clear for ClientToAPI {
    fn clear(&mut self) {
        self.secret.clear();
        self.registration_payload.clear();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for ClientToAPI {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ClientToAPI {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
impl<'a> ::std::default::Default for &'a ZMQPayload {
    fn default() -> &'a ZMQPayload {
        <ZMQPayload as ::protobuf::Message>::default_instance()
    }
}

impl ZMQPayload {
    pub fn new() -> ZMQPayload {
        ::std::default::Default::default()
    }
    ...
    pub fn get_registration_source(&self) -> RegistrationSource {
        self.registration_source.unwrap_or(RegistrationSource::Detector)
    }
...
impl ::protobuf::Message for ZMQPayload {
    fn is_initialized(&self) -> bool {
        for v in &self.registration_payload {
            if !v.is_initialized() {
                return false;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                "shared_secret",
                |m: &ZMQPayload| { &m.shared_secret },
                |m: &mut ZMQPayload| { &mut m.shared_secret },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<ClientToStation>>(
                "registration_payload",
                |m: &ZMQPayload| { &m.registration_payload },
                |m: &mut ZMQPayload| { &mut m.registration_payload },
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeEnum<RegistrationSource>>(
                "registration_source",
                |m: &ZMQPayload| { &m.registration_source },
                |m: &mut ZMQPayload| { &mut m.registration_source },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<ZMQPayload>(
                "ZMQPayload",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static ZMQPayload {
        static instance: ::protobuf::rt::LazyV2<ZMQPayload> = ::protobuf::rt::LazyV2::INIT;
        instance.get(ZMQPayload::new)
    }
}

impl ::protobuf::Clear for ZMQPayload {
    fn clear(&mut self) {
        self.shared_secret.clear();
        self.registration_payload.clear();
        self.registration_source = ::std::option::Option::None;
...
impl ::std::fmt::Debug for ZMQPayload {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ZMQPayload {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
impl ::protobuf::ProtobufEnum for TransportType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<TransportType> {
        match value {
            0 => ::std::option::Option::Some(TransportType::NullTransport),
            1 => ::std::option::Option::Some(TransportType::MinTransport),
            2 => ::std::option::Option::Some(TransportType::Obfs4Transport),
            _ => ::std::option::Option::None
        }
    }
    ...
    fn values() -> &'static [Self] {
        static values: &'static [TransportType] = &[
            TransportType::NullTransport,
            TransportType::MinTransport,
            TransportType::Obfs4Transport,
        ];
        values
    }
...
impl ::protobuf::ProtobufEnum for RegistrationSource {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<RegistrationSource> {
        match value {
            0 => ::std::option::Option::Some(RegistrationSource::Detector),
            1 => ::std::option::Option::Some(RegistrationSource::API),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \tR\tstationId\x12\x18\n\x07padding\x18d\x20\x01(\x0cR\x07padding\"\x8f\
    ...
    \x01(\x0b2\x1b.tapdance.RegistrationFlagsR\x05flags\x12\x18\n\x07padding\
    \x18d\x20\x01(\x0cR\x07padding\"s\n\x0bClientToAPI\x12\x16\n\x06secret\
    \x18\x01\x20\x01(\x0cR\x06secret\x12L\n\x14registration_payload\x18\x02\
    \x20\x01(\x0b2\x19.tapdance.ClientToStationR\x13registrationPayload\"\
    ...
    nSource\"\xdd\x01\n\x0cSessionStats\x120\n\x14failed_decoys_amount\x18\
    \x14\x20\x01(\rR\x12failedDecoysAmount\x121\n\x15total_time_to_connect\
    \x18\x1f\x20\x01(\rR\x12totalTimeToConnect\x12$\n\x0ertt_to_station\x18!\
    \x20\x01(\rR\x0crttToStation\x12\x20\n\x0ctls_to_decoy\x18&\x20\x01(\rR\
    ...
    \x03\0\0\x12\n\xb0\x01\n\x01\x02\x12\x03\x06\0\x112\xa5\x01\x20TODO:\x20\
    We're\x20using\x20proto2\x20because\x20it's\x20the\x20default\x20on\x20U\
    buntu\x2016.04.\n\x20At\x20some\x20point\x20we\x20will\x20want\x20to\x20\
    migrate\x20to\x20proto3,\x20but\x20we\x20are\x20not\n\x20using\x20any\
    \x20proto3\x20features\x20yet.\n\n\n\n\x02\x05\0\x12\x04\x08\0\x0b\x01\n\
    \n\n\x03\x05\0\x01\x12\x03\x08\x05\x0c\n\x0b\n\x04\x05\0\x02\0\x12\x03\t\
    \x04\x15\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03\t\x04\x0f\n\x0c\n\x05\x05\0\
    \x02\0\x02\x12\x03\t\x12\x14\n\x20\n\x04\x05\0\x02\x01\x12\x03\n\x04\x15\
    \"\x13\x20not\x20supported\x20atm\n\n\x0c\n\x05\x05\0\x02\x01\x01\x12\
    \x03\n\x04\x0f\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\n\x12\x14\n\n\n\x02\
    \x04\0\x12\x04\r\0\x12\x01\n\n\n\x03\x04\0\x01\x12\x03\r\x08\x0e\n4\n\
    \x04\x04\0\x02\0\x12\x03\x0f\x04\x1b\x1a'\x20A\x20public\x20key,\x20as\
    \x20used\x20by\x20the\x20station.\n\n\x0c\n\x05\x04\0\x02\0\x04\x12\x03\
    \x0f\x04\x0c\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\x0f\r\x12\n\x0c\n\x05\
    \x04\0\x02\0\x01\x12\x03\x0f\x13\x16\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\
    \x0f\x19\x1a\n\x0b\n\x04\x04\0\x02\x01\x12\x03\x11\x04\x1e\n\x0c\n\x05\
    \x04\0\x02\x01\x04\x12\x03\x11\x04\x0c\n\x0c\n\x05\x04\0\x02\x01\x06\x12\
    ...
    \x01\x02\0\x12\x03\x19\x04!\x1a\x93\x01\x20The\x20hostname/SNI\x20to\x20\
    ...
    \x04\x02\x02\x03\x01\x12\x03U\x1d.\n\x0c\n\x05\x04\x02\x02\x03\x03\x12\
    ...
    b\0l\x01\x1a!\x20State\x20transitions\x20of\x20the\x20client\n\n\n\n\x03\
    \x05\x01\x01\x12\x03b\x05\x13\n\x0b\n\x04\x05\x01\x02\0\x12\x03c\x04\x16\
    \n\x0c\n\x05\x05\x01\x02\0\x01\x12\x03c\x04\x11\n\x0c\n\x05\x05\x01\x02\
    \0\x02\x12\x03c\x14\x15\n\"\n\x04\x05\x01\x02\x01\x12\x03d\x04\x19\"\x15\
    \x20connect\x20me\x20to\x20squid\n\n\x0c\n\x05\x05\x01\x02\x01\x01\x12\
    \x03d\x04\x14\n\x0c\n\x05\x05\x01\x02\x01\x02\x12\x03d\x17\x18\n,\n\x04\
    \x05\x01\x02\x02\x12\x03e\x04!\"\x1f\x20connect\x20me\x20to\x20provided\
    ...
    z\0\x84\x01\x01\x1a*\x20Should\x20accompany\x20all\x20S2C_ERROR\x20messa\
    ...
    |\x04\x16\"\x1c\x20Squid\x20TCP\x20connection\x20broke\n\n\x0c\n\x05\x05\
    \x03\x02\x01\x01\x12\x03|\x04\x11\n\x0c\n\x05\x05\x03\x02\x01\x02\x12\
    \x03|\x14\x15\n6\n\x04\x05\x03\x02\x02\x12\x03}\x04\x18\")\x20You\x20tol\
    d\x20me\x20something\x20was\x20wrong,\x20client\n\n\x0c\n\x05\x05\x03\
    \x02\x02\x01\x12\x03}\x04\x13\n\x0c\n\x05\x05\x03\x02\x02\x02\x12\x03}\
    \x16\x17\n?\n\x04\x05\x03\x02\x03\x12\x03~\x04\x18\"2\x20You\x20messed\
    \x20up,\x20client\x20(e.g.\x20sent\x20a\x20bad\x20protobuf)\n\n\x0c\n\
    \x05\x05\x03\x02\x03\x01\x12\x03~\x04\x13\n\x0c\n\x05\x05\x03\x02\x03\
    \x02\x12\x03~\x16\x17\n\x16\n\x04\x05\x03\x02\x04\x12\x03\x7f\x04\x19\"\
    \t\x20I\x20broke\n\n\x0c\n\x05\x05\x03\x02\x04\x01\x12\x03\x7f\x04\x14\n\
    \x0c\n\x05\x05\x03\x02\x04\x02\x12\x03\x7f\x17\x18\nE\n\x04\x05\x03\x02\
    \x05\x12\x04\x80\x01\x04\x17\"7\x20Everything's\x20fine,\x20but\x20don't\
    \x20use\x20this\x20decoy\x20right\x20now\n\n\r\n\x05\x05\x03\x02\x05\x01\
    \x12\x04\x80\x01\x04\x12\n\r\n\x05\x05\x03\x02\x05\x02\x12\x04\x80\x01\
    \x15\x16\nD\n\x04\x05\x03\x02\x06\x12\x04\x82\x01\x04\x18\"6\x20My\x20st\
    ream\x20to\x20you\x20broke.\x20(This\x20is\x20impossible\x20to\x20send)\
    \n\n\r\n\x05\x05\x03\x02\x06\x01\x12\x04\x82\x01\x04\x11\n\r\n\x05\x05\
    \x03\x02\x06\x02\x12\x04\x82\x01\x14\x17\nA\n\x04\x05\x03\x02\x07\x12\
    \x04\x83\x01\x04\x19\"3\x20You\x20never\x20came\x20back.\x20(This\x20is\
    ...
    \x12\x04\x86\x01\x05\x12\n\x0c\n\x04\x05\x04\x02\0\x12\x04\x87\x01\x04\
    \x16\n\r\n\x05\x05\x04\x02\0\x01\x12\x04\x87\x01\x04\x11\n\r\n\x05\x05\
    \x04\x02\0\x02\x12\x04\x87\x01\x14\x15\n`\n\x04\x05\x04\x02\x01\x12\x04\
    \x88\x01\x04\x15\"R\x20Send\x20a\x2032-byte\x20HMAC\x20id\x20to\x20let\
    \x20the\x20station\x20distinguish\x20registrations\x20to\x20same\x20host\
    \n\n\r\n\x05\x05\x04\x02\x01\x01\x12\x04\x88\x01\x04\x10\n\r\n\x05\x05\
    \x04\x02\x01\x02\x12\x04\x88\x01\x13\x14\n$\n\x04\x05\x04\x02\x02\x12\
    \x04\x89\x01\x04\x17\"\x16\x20Not\x20implemented\x20yet?\n\n\r\n\x05\x05\
    \x04\x02\x02\x01\x12\x04\x89\x01\x04\x12\n\r\n\x05\x05\x04\x02\x02\x02\
    \x12\x04\x89\x01\x15\x16\n\x0c\n\x02\x04\x05\x12\x06\x8c\x01\0\xa3\x01\
    \x01\n\x0b\n\x03\x04\x05\x01\x12\x04\x8c\x01\x08\x17\nO\n\x04\x04\x05\
    \x02\0\x12\x04\x8e\x01\x04)\x1aA\x20Should\x20accompany\x20(at\x20least)\
    \x20SESSION_INIT\x20and\x20CONFIRM_RECONNECT.\n\n\r\n\x05\x04\x05\x02\0\
    \x04\x12\x04\x8e\x01\x04\x0c\n\r\n\x05\x04\x05\x02\0\x05\x12\x04\x8e\x01\
    \r\x13\n\r\n\x05\x04\x05\x02\0\x01\x12\x04\x8e\x01\x14$\n\r\n\x05\x04\
    \x05\x02\0\x03\x12\x04\x8e\x01'(\nv\n\x04\x04\x05\x02\x01\x12\x04\x92\
    \x01\x041\x1ah\x20There\x20might\x20be\x20a\x20state\x20transition.\x20M\
    ay\x20be\x20absent;\x20absence\x20should\x20be\n\x20treated\x20identical\
    ly\x20to\x20NO_CHANGE.\n\n\r\n\x05\x04\x05\x02\x01\x04\x12\x04\x92\x01\
    \x04\x0c\n\r\n\x05\x04\x05\x02\x01\x06\x12\x04\x92\x01\r\x1b\n\r\n\x05\
    \x04\x05\x02\x01\x01\x12\x04\x92\x01\x1c,\n\r\n\x05\x04\x05\x02\x01\x03\
    \x12\x04\x92\x01/0\nc\n\x04\x04\x05\x02\x02\x12\x04\x96\x01\x04(\x1aU\
    ...
    \x04\x05\x02\x02\x04\x12\x04\x96\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x02\
    \x06\x12\x04\x96\x01\r\x17\n\r\n\x05\x04\x05\x02\x02\x01\x12\x04\x96\x01\
    \x18#\n\r\n\x05\x04\x05\x02\x02\x03\x12\x04\x96\x01&'\nP\n\x04\x04\x05\
    \x02\x03\x12\x04\x99\x01\x04+\x1aB\x20If\x20state_transition\x20==\x20S2\
    C_ERROR,\x20this\x20field\x20is\x20the\x20explanation.\n\n\r\n\x05\x04\
    \x05\x02\x03\x04\x12\x04\x99\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x03\x06\
    \x12\x04\x99\x01\r\x1b\n\r\n\x05\x04\x05\x02\x03\x01\x12\x04\x99\x01\x1c\
    &\n\r\n\x05\x04\x05\x02\x03\x03\x12\x04\x99\x01)*\nQ\n\x04\x04\x05\x02\
    \x04\x12\x04\x9c\x01\x04$\x1aC\x20Signals\x20client\x20to\x20stop\x20con\
    necting\x20for\x20following\x20amount\x20of\x20seconds\n\n\r\n\x05\x04\
    \x05\x02\x04\x04\x12\x04\x9c\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x04\x05\
    \x12\x04\x9c\x01\r\x13\n\r\n\x05\x04\x05\x02\x04\x01\x12\x04\x9c\x01\x14\
    \x1f\n\r\n\x05\x04\x05\x02\x04\x03\x12\x04\x9c\x01\"#\nK\n\x04\x04\x05\
    \x02\x05\x12\x04\x9f\x01\x04#\x1a=\x20Sent\x20in\x20SESSION_INIT,\x20ide\
    ntifies\x20the\x20station\x20that\x20picked\x20up\n\n\r\n\x05\x04\x05\
    \x02\x05\x04\x12\x04\x9f\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x05\x05\x12\
    \x04\x9f\x01\r\x13\n\r\n\x05\x04\x05\x02\x05\x01\x12\x04\x9f\x01\x14\x1e\
    \n\r\n\x05\x04\x05\x02\x05\x03\x12\x04\x9f\x01!\"\nG\n\x04\x04\x05\x02\
    \x06\x12\x04\xa2\x01\x04!\x1a9\x20Random-sized\x20junk\x20to\x20defeat\
    \x20packet\x20size\x20fingerprinting.\n\n\r\n\x05\x04\x05\x02\x06\x04\
    \x12\x04\xa2\x01\x04\x0c\n\r\n\x05\x04\x05\x02\x06\x05\x12\x04\xa2\x01\r\
    \x12\n\r\n\x05\x04\x05\x02\x06\x01\x12\x04\xa2\x01\x13\x1a\n\r\n\x05\x04\
    \x05\x02\x06\x03\x12\x04\xa2\x01\x1d\x20\n\x0c\n\x02\x04\x06\x12\x06\xa5\
    \x01\0\xaa\x01\x01\n\x0b\n\x03\x04\x06\x01\x12\x04\xa5\x01\x08\x19\n\x0c\
    \n\x04\x04\x06\x02\0\x12\x04\xa6\x01\x08&\n\r\n\x05\x04\x06\x02\0\x04\
    \x12\x04\xa6\x01\x08\x10\n\r\n\x05\x04\x06\x02\0\x05\x12\x04\xa6\x01\x11\
    \x15\n\r\n\x05\x04\x06\x02\0\x01\x12\x04\xa6\x01\x16!\n\r\n\x05\x04\x06\
    \x02\0\x03\x12\x04\xa6\x01$%\n\x0c\n\x04\x04\x06\x02\x01\x12\x04\xa7\x01\
    \x08%\n\r\n\x05\x04\x06\x02\x01\x04\x12\x04\xa7\x01\x08\x10\n\r\n\x05\
    \x04\x06\x02\x01\x05\x12\x04\xa7\x01\x11\x15\n\r\n\x05\x04\x06\x02\x01\
    \x01\x12\x04\xa7\x01\x16\x20\n\r\n\x05\x04\x06\x02\x01\x03\x12\x04\xa7\
    \x01#$\n\x0c\n\x04\x04\x06\x02\x02\x12\x04\xa8\x01\x08'\n\r\n\x05\x04\
    \x06\x02\x02\x04\x12\x04\xa8\x01\x08\x10\n\r\n\x05\x04\x06\x02\x02\x05\
    \x12\x04\xa8\x01\x11\x15\n\r\n\x05\x04\x06\x02\x02\x01\x12\x04\xa8\x01\
    \x16\"\n\r\n\x05\x04\x06\x02\x02\x03\x12\x04\xa8\x01%&\n\x0c\n\x04\x04\
    \x06\x02\x03\x12\x04\xa9\x01\x08\"\n\r\n\x05\x04\x06\x02\x03\x04\x12\x04\
    \xa9\x01\x08\x10\n\r\n\x05\x04\x06\x02\x03\x05\x12\x04\xa9\x01\x11\x15\n\
    \r\n\x05\x04\x06\x02\x03\x01\x12\x04\xa9\x01\x16\x1d\n\r\n\x05\x04\x06\
    \x02\x03\x03\x12\x04\xa9\x01\x20!\n\x0c\n\x02\x04\x07\x12\x06\xac\x01\0\
    \xd8\x01\x01\n\x0b\n\x03\x04\x07\x01\x12\x04\xac\x01\x08\x17\n\x0c\n\x04\
    \x04\x07\x02\0\x12\x04\xad\x01\x04)\n\r\n\x05\x04\x07\x02\0\x04\x12\x04\
    \xad\x01\x04\x0c\n\r\n\x05\x04\x07\x02\0\x05\x12\x04\xad\x01\r\x13\n\r\n\
    \x05\x04\x07\x02\0\x01\x12\x04\xad\x01\x14$\n\r\n\x05\x04\x07\x02\0\x03\
    \x12\x04\xad\x01'(\n\xd0\x01\n\x04\x04\x07\x02\x01\x12\x04\xb2\x01\x04.\
    ...
    d\x20is\x20set\x20to\x200.\n\n\r\n\x05\x04\x07\x02\x01\x04\x12\x04\xb2\
    ...
    \x02\x02\x06\x12\x04\xb4\x01\r\x1b\n\r\n\x05\x04\x07\x02\x02\x01\x12\x04\
    \xb4\x01\x1c,\n\r\n\x05\x04\x07\x02\x02\x03\x12\x04\xb4\x01/0\n\x80\x01\
    \n\x04\x04\x07\x02\x03\x12\x04\xb8\x01\x04$\x1ar\x20The\x20position\x20i\
    ...
    G\n\x04\x04\x07\x02\x0c\x12\x04\xd7\x01\x04!\x1a9\x20Random-sized\x20jun\
    k\x20to\x20defeat\x20packet\x20size\x20fingerprinting.\n\n\r\n\x05\x04\
    \x07\x02\x0c\x04\x12\x04\xd7\x01\x04\x0c\n\r\n\x05\x04\x07\x02\x0c\x05\
    \x12\x04\xd7\x01\r\x12\n\r\n\x05\x04\x07\x02\x0c\x01\x12\x04\xd7\x01\x13\
    \x1a\n\r\n\x05\x04\x07\x02\x0c\x03\x12\x04\xd7\x01\x1d\x20\n\xbe\x01\n\
    \x02\x04\x08\x12\x06\xdc\x01\0\xe2\x01\x01\x1a\xaf\x01\x20Message\x20typ\
    e\x20used\x20as\x20the\x20request\x20body\x20when\x20registering\x20via\
    \x20the\x20HTTP\x20API.\n\x20This\x20message\x20is\x20assumed\x20to\x20b\
    e\x20sent\x20via\x20TLS,\x20meaning\x20that\x20sending\x20the\x20secret\
    \x20outright\x20is\x20acceptable.\n\n\x0b\n\x03\x04\x08\x01\x12\x04\xdc\
    \x01\x08\x13\nN\n\x04\x04\x08\x02\0\x12\x04\xde\x01\x04\x1e\x1a@\x20The\
    \x20secret\x20that\x20will\x20be\x20used\x20when\x20forming\x20phantom\
    \x20connections.\n\n\r\n\x05\x04\x08\x02\0\x04\x12\x04\xde\x01\x04\x0c\n\
    \r\n\x05\x04\x08\x02\0\x05\x12\x04\xde\x01\r\x12\n\r\n\x05\x04\x08\x02\0\
    \x01\x12\x04\xde\x01\x13\x19\n\r\n\x05\x04\x08\x02\0\x03\x12\x04\xde\x01\
    \x1c\x1d\nU\n\x04\x04\x08\x02\x01\x12\x04\xe1\x01\x046\x1aG\x20The\x20Cl\
    ientToStation\x20payload;\x20the\x20same\x20as\x20used\x20in\x20decoy\
    \x20registrations.\n\n\r\n\x05\x04\x08\x02\x01\x04\x12\x04\xe1\x01\x04\
    \x0c\n\r\n\x05\x04\x08\x02\x01\x06\x12\x04\xe1\x01\r\x1c\n\r\n\x05\x04\
    \x08\x02\x01\x01\x12\x04\xe1\x01\x1d1\n\r\n\x05\x04\x08\x02\x01\x03\x12\
    ...
    \x02\x01\x12\x04\xe6\x01\x08\x10\n\r\n\x05\x05\x05\x02\x01\x01\x12\x04\
